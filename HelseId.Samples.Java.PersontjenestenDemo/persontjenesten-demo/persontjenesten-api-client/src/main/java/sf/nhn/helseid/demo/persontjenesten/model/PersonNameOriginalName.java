 ...
 */
@ApiModel(description = "Provided in the same language/character set as in the original identification document (ISO-10646)  <br>FREG: OriginaltNavn")
...
public class PersonNameOriginalName {
  ...
  public PersonNameOriginalName() {
  }

  public PersonNameOriginalName givenName(String givenName) {
  ...
  **/
  ...
  public PersonNameOriginalName middleName(String middleName) {
  ...
  **/
  ...
  public PersonNameOriginalName familyName(String familyName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PersonNameOriginalName personNameOriginalName = (PersonNameOriginalName) o;
    return Objects.equals(this.givenName, personNameOriginalName.givenName) &&
        Objects.equals(this.middleName, personNameOriginalName.middleName) &&
        Objects.equals(this.familyName, personNameOriginalName.familyName);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PersonNameOriginalName
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PersonNameOriginalName.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonNameOriginalName is not found in the empty JSON string", PersonNameOriginalName.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PersonNameOriginalName.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonNameOriginalName` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PersonNameOriginalName.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PersonNameOriginalName' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PersonNameOriginalName> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PersonNameOriginalName.class));

       return (TypeAdapter<T>) new TypeAdapter<PersonNameOriginalName>() {
           @Override
           public void write(JsonWriter out, PersonNameOriginalName value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PersonNameOriginalName read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PersonNameOriginalName given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PersonNameOriginalName
  * @throws IOException if the JSON string is invalid with respect to PersonNameOriginalName
  */
  public static PersonNameOriginalName fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonNameOriginalName.class);
  }

 /**
  * Convert an instance of PersonNameOriginalName to an JSON string
  *
  * @return JSON string
  */
