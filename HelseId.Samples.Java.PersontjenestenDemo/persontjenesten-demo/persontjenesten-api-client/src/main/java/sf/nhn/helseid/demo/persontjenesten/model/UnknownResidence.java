 ...
 */
@ApiModel(description = "Person has an unknown address  <br>FREG: UkjentBosted")
...
public class UnknownResidence {
  ...
  * @throws IOException if the JSON Object is invalid with respect to UnknownResidence
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (UnknownResidence.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UnknownResidence.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnknownResidence` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
