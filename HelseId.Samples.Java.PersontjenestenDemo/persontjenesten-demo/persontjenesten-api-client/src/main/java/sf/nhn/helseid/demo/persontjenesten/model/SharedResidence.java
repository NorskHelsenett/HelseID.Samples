 ...
 */
@ApiModel(description = "Address information on shared parenting, shared residence or joint residence  <br>Remarks:   NB! This may be outdated!  Only one of StreetAddress, CadastralAddress  or UnknownResidence is in use.  Contains address information based on the original shared parental agreement.  This address is a copy of the address for the parent not sharing residence  with the child at that point.  This address will not be updated if that parent moves.                See also Person.ResidentialAddress                Freg: Folkeregisterperson.DeltBosted")
...
public class SharedResidence {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Start date for the agreement between parents for  the shared residence  <br>FREG: StartdatoForKontrak")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "End date for the agreement between parents for  the shared residence  <br>Remarks:   May not have a end date  Freg: SluttdatoForKontrak")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Unique identifier from the Mapping Authority.  Used to catch changes to the Cadastral  <br>FREG: AdresseidentifikatorFraMatrikkelen")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ResidentialAddress.CloseCadastralIdentifier  <br>FREG: NaerAdresseIdentifikatorFraMatrikkelen")
  ...
  * @throws IOException if the JSON Object is invalid with respect to SharedResidence
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SharedResidence.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SharedResidence.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SharedResidence` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("streetAddress") != null && !jsonObj.get("streetAddress").isJsonNull()) {
        SharedResidenceStreetAddress.validateJsonObject(jsonObj.getAsJsonObject("streetAddress"));
      }
      // validate the optional field `cadastralAddress`
      if (jsonObj.get("cadastralAddress") != null && !jsonObj.get("cadastralAddress").isJsonNull()) {
        SharedResidenceCadastralAddress.validateJsonObject(jsonObj.getAsJsonObject("cadastralAddress"));
      }
      // validate the optional field `unknownResidence`
      if (jsonObj.get("unknownResidence") != null && !jsonObj.get("unknownResidence").isJsonNull()) {
        SharedResidenceUnknownResidence.validateJsonObject(jsonObj.getAsJsonObject("unknownResidence"));
      }
