 ...
 */
@ApiModel(description = "Street address for post usage  Describes the address where a person lives, stays or has shared parental residence  <br>FREG: VegadresseForPost")
...
public class StreetAddressForPost {
  ...
  * @throws IOException if the JSON Object is invalid with respect to StreetAddressForPost
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (StreetAddressForPost.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StreetAddressForPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreetAddressForPost` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
