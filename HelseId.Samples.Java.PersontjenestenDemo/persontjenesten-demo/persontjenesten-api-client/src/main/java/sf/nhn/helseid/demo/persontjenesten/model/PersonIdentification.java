 ...
 */
@ApiModel(description = "Identification for a person, used for foreign persons identification and immigration authorities identification  <br>FREG: Personidentifikasjon  ")
...
public class PersonIdentification {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The identification number  <br>FREG: Identifikasjonsnummer")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Type of foreign identification  Possible values:  - utenlandskIdentifikasjonsnummer = Foreign identification number  - taxIdentificationNumber = Tax Identification Number(TIN)  - socialSecurityNumber = Social Security Number(SSN)  - utlendingsmyndighetenesIdentifikasjonsnummer = \"DUF-nummer\" from the Norwegian UDI, for now  <br>FREG: Identifikasjonsnummertype")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "POL", value = "Country codes given in ISO 3166-1 Alpha 3  Always NOR for Person.ImmigrationAuthoritiesIdentificationNumber  XXK = Kosovo  <br>FREG: Utstederland")
  ...
  * @throws IOException if the JSON Object is invalid with respect to PersonIdentification
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PersonIdentification.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PersonIdentification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonIdentification` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
