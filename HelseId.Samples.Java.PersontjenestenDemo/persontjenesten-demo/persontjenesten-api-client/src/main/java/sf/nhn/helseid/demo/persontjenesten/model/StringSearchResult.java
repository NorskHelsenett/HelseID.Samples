...
public class StringSearchResult {
  ...
  * @throws IOException if the JSON Object is invalid with respect to StringSearchResult
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (StringSearchResult.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StringSearchResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StringSearchResult` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
