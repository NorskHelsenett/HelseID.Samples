 ...
 */
@ApiModel(description = "A number and maybe letters that uniquely identifiers property,  facilities, buildings or entrances to building within  an addressable street, road, path, place or area  as registered in the cadastral of a municipality  <br>FREG: Adressenummmer")
...
public class StreetAddressAddressNumber {
  public static final String SERIALIZED_NAME_HOUSE_NUMBER = "houseNumber";
  @SerializedName(SERIALIZED_NAME_HOUSE_NUMBER)
  private String houseNumber;

  public static final String SERIALIZED_NAME_HOUSE_LETTER = "houseLetter";
  @SerializedName(SERIALIZED_NAME_HOUSE_LETTER)
  private String houseLetter;

  public StreetAddressAddressNumber() {
  }

  public StreetAddressAddressNumber houseNumber(String houseNumber) {
  ...
  **/
  ...
  @ApiModelProperty(example = "160", value = "A number that uniquely identifiers property,  facilities, buildings or entrances to building within  an addressable street, road, path, place or area  <br>FREG: Husnummer")
  ...
  public StreetAddressAddressNumber houseLetter(String houseLetter) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "B", value = "A letter that together with HouseNumber  uniquely identifiers property, facilities, buildings  or entrances to building within an addressable  street, road, path, place or area  <br>FREG: Husbokstav")
  ...
  public boolean equals(Object o) {
    ...
    StreetAddressAddressNumber streetAddressAddressNumber = (StreetAddressAddressNumber) o;
    return Objects.equals(this.houseNumber, streetAddressAddressNumber.houseNumber) &&
        Objects.equals(this.houseLetter, streetAddressAddressNumber.houseLetter);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(houseNumber, houseLetter);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to StreetAddressAddressNumber
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (StreetAddressAddressNumber.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreetAddressAddressNumber is not found in the empty JSON string", StreetAddressAddressNumber.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StreetAddressAddressNumber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreetAddressAddressNumber` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if ((jsonObj.get("houseLetter") != null && !jsonObj.get("houseLetter").isJsonNull()) && !jsonObj.get("houseLetter").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `houseLetter` to be a primitive type in the JSON string but got `%s`", jsonObj.get("houseLetter").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreetAddressAddressNumber.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreetAddressAddressNumber' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreetAddressAddressNumber> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreetAddressAddressNumber.class));

       return (TypeAdapter<T>) new TypeAdapter<StreetAddressAddressNumber>() {
           @Override
           public void write(JsonWriter out, StreetAddressAddressNumber value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreetAddressAddressNumber read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of StreetAddressAddressNumber given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of StreetAddressAddressNumber
  * @throws IOException if the JSON string is invalid with respect to StreetAddressAddressNumber
  */
  public static StreetAddressAddressNumber fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreetAddressAddressNumber.class);
  }

 /**
  * Convert an instance of StreetAddressAddressNumber to an JSON string
  *
  * @return JSON string
  */
