 ...
 */
@ApiModel(description = "<br>FREG: Matrikkeladresse")
...
public class PresentAddressCadastralAddress {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PresentAddressCadastralAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PresentAddressCadastralAddress.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PresentAddressCadastralAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PresentAddressCadastralAddress` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
