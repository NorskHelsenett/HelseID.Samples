 ...
 */
@ApiModel(description = "Information on a persons death.  <br>FREG: Doedsfall")
...
public class Death {
  ...
  public Death registeredAt(OffsetDateTime registeredAt) {
  ...
  **/
  ...
  public Death isValid(Boolean isValid) {
  ...
  **/
  ...
  public Death source(String source) {
  ...
  **/
  ...
  public Death reason(String reason) {
  ...
  **/
  ...
  public Death validFrom(OffsetDateTime validFrom) {
  ...
  **/
  ...
  public Death validTo(OffsetDateTime validTo) {
  ...
  **/
  ...
  public Death deceasedDate(OffsetDateTime deceasedDate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Death death = (Death) o;
    return Objects.equals(this.registeredAt, death.registeredAt) &&
        Objects.equals(this.isValid, death.isValid) &&
        Objects.equals(this.source, death.source) &&
        Objects.equals(this.reason, death.reason) &&
        Objects.equals(this.validFrom, death.validFrom) &&
        Objects.equals(this.validTo, death.validTo) &&
        Objects.equals(this.deceasedDate, death.deceasedDate);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Death
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (Death.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in Death is not found in the empty JSON string", Death.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Death.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Death` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Death.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Death' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Death> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Death.class));

       return (TypeAdapter<T>) new TypeAdapter<Death>() {
           @Override
           public void write(JsonWriter out, Death value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Death read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Death given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Death
  * @throws IOException if the JSON string is invalid with respect to Death
  */
  public static Death fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Death.class);
  }

 /**
  * Convert an instance of Death to an JSON string
  *
  * @return JSON string
  */
