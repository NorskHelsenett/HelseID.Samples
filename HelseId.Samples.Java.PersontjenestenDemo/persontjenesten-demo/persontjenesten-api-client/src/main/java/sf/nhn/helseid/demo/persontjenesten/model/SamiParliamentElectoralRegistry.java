 ...
 */
@ApiModel(description = "<br>FREG: SametingetsValgmanntall")
...
public class SamiParliamentElectoralRegistry {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Vedtaksdato")
  ...
  * @throws IOException if the JSON Object is invalid with respect to SamiParliamentElectoralRegistry
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SamiParliamentElectoralRegistry.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SamiParliamentElectoralRegistry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SamiParliamentElectoralRegistry` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
