...
namespace HelseId.APIAccessNewToken
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Creates a HttpClient instance to be used in the application
            services.AddHttpClient();

            // Creates a singleton from instance that caches the discovery document the first time it is needed, and then cache it for 24 hours.
            // The discovery cache is setup and uses HttpClientFactory to create clients
