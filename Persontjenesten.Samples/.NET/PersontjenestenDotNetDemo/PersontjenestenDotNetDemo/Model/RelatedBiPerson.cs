...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RelatedBiPerson")]
    public partial class RelatedBiPerson : IEquatable<RelatedBiPerson>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RelatedBiPerson" /> class.
        /// </summary>
        ...
        public RelatedBiPerson(GuardianOrProxyName name = default(GuardianOrProxyName), DateTime? birthDate = default(DateTime?), string citizenship = default(string), Gender? gender = default(Gender?))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as RelatedBiPerson);
        }

        /// <summary>
        /// Returns true if RelatedBiPerson instances are equal
        /// </summary>
        /// <param name="input">Instance of RelatedBiPerson to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelatedBiPerson input)
        {
            if (input == null)
            {
                return false;
