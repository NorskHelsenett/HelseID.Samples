...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ForeignContactAddress_foreignAddress")]
    public partial class ForeignContactAddressForeignAddress : IEquatable<ForeignContactAddressForeignAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForeignContactAddressForeignAddress" /> class.
        /// </summary>
        ...
        public ForeignContactAddressForeignAddress(string coAddressName = default(string), string addressName = default(string), string building = default(string), string floorNumber = default(string), string housingUnit = default(string), string postBox = default(string), string postCode = default(string), string cityOrPlaceName = default(string), string districtName = default(string), string region = default(string), string countryCode = default(string))
        {
        ...
        {
            return this.Equals(input as ForeignContactAddressForeignAddress);
        }

        /// <summary>
        /// Returns true if ForeignContactAddressForeignAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ForeignContactAddressForeignAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForeignContactAddressForeignAddress input)
        {
            if (input == null)
            {
                return false;
