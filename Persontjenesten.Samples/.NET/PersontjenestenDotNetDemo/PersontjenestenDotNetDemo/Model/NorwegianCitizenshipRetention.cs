...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NorwegianCitizenshipRetention")]
    public partial class NorwegianCitizenshipRetention : IEquatable<NorwegianCitizenshipRetention>, IValidatableObject
    {

        /// <summary>
        /// &lt;br&gt;FREG: Bibeholdstatus
        /// </summary>
        /// <value>&lt;br&gt;FREG: Bibeholdstatus</value>
        [DataMember(Name = "citizenshipRetentionStatus", EmitDefaultValue = false)]
        public CitizenshipRetentionStatus? CitizenshipRetentionStatus { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="NorwegianCitizenshipRetention" /> class.
        /// </summary>
        ...
        /// <param name="citizenshipRetentionStatus">&lt;br&gt;FREG: Bibeholdstatus.</param>
        /// <param name="retentionResolutionDate">The resolution date of retention of norwegian citizenship  &lt;br&gt;FREG: DatoForBibehold.</param>
        public NorwegianCitizenshipRetention(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), CitizenshipRetentionStatus? citizenshipRetentionStatus = default(CitizenshipRetentionStatus?), DateTime? retentionResolutionDate = default(DateTime?))
        {
        ...
        /// </summary>
        /// <value>The resolution date of retention of norwegian citizenship  &lt;br&gt;FREG: DatoForBibehold</value>
        [DataMember(Name = "retentionResolutionDate", EmitDefaultValue = true)]
        public DateTime? RetentionResolutionDate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CitizenshipRetentionStatus: ").Append(CitizenshipRetentionStatus).Append("\n");
            sb.Append("  RetentionResolutionDate: ").Append(RetentionResolutionDate).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as NorwegianCitizenshipRetention);
        }

        /// <summary>
        /// Returns true if NorwegianCitizenshipRetention instances are equal
        /// </summary>
        /// <param name="input">Instance of NorwegianCitizenshipRetention to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NorwegianCitizenshipRetention input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CitizenshipRetentionStatus == input.CitizenshipRetentionStatus ||
                    this.CitizenshipRetentionStatus.Equals(input.CitizenshipRetentionStatus)
                ) && 
                (
                    this.RetentionResolutionDate == input.RetentionResolutionDate ||
                    (this.RetentionResolutionDate != null &&
                    this.RetentionResolutionDate.Equals(input.RetentionResolutionDate))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CitizenshipRetentionStatus.GetHashCode();
                if (this.RetentionResolutionDate != null)
                {
                    hashCode = (hashCode * 59) + this.RetentionResolutionDate.GetHashCode();
                }
                return hashCode;
            }
        }
