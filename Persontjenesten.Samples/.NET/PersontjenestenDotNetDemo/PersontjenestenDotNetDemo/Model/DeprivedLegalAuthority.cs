...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeprivedLegalAuthority")]
    public partial class DeprivedLegalAuthority : IEquatable<DeprivedLegalAuthority>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeprivedLegalAuthority" /> class.
        /// </summary>
        ...
        public DeprivedLegalAuthority(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?))
        {
        ...
        {
            return this.Equals(input as DeprivedLegalAuthority);
        }

        /// <summary>
        /// Returns true if DeprivedLegalAuthority instances are equal
        /// </summary>
        /// <param name="input">Instance of DeprivedLegalAuthority to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeprivedLegalAuthority input)
        {
            if (input == null)
            {
                return false;
