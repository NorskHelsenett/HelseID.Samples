...
namespace Org.OpenAPITools.Model
{
    ...
    /// &lt;br&gt;FREG: Doedsfall
    /// </summary>
    [DataContract(Name = "Person_death")]
    public partial class PersonDeath : IEquatable<PersonDeath>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonDeath" /> class.
        /// </summary>
        ...
        /// <param name="deceasedDate">The date when the person was decleared dead.  &lt;br&gt;FREG: Doedsdato.</param>
        public PersonDeath(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), DateTime? deceasedDate = default(DateTime?))
        {
        ...
        /// </summary>
        /// <value>The date when the person was decleared dead.  &lt;br&gt;FREG: Doedsdato</value>
        ...
        {
            return this.Equals(input as PersonDeath);
        }

        /// <summary>
        /// Returns true if PersonDeath instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonDeath to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonDeath input)
        {
            if (input == null)
            {
                return false;
