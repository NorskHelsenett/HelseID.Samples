...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ContactAddress_freeFormPostalAddress")]
    public partial class ContactAddressFreeFormPostalAddress : IEquatable<ContactAddressFreeFormPostalAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactAddressFreeFormPostalAddress" /> class.
        /// </summary>
        /// <param name="adresselinje">&lt;br&gt;FREG: Adresselinje.</param>
        /// <param name="city">city.</param>
        public ContactAddressFreeFormPostalAddress(List<string> adresselinje = default(List<string>), CadastralAddressCity city = default(CadastralAddressCity))
        {
        ...
        {
            return this.Equals(input as ContactAddressFreeFormPostalAddress);
        }

        /// <summary>
        /// Returns true if ContactAddressFreeFormPostalAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactAddressFreeFormPostalAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactAddressFreeFormPostalAddress input)
        {
            if (input == null)
            {
                return false;
