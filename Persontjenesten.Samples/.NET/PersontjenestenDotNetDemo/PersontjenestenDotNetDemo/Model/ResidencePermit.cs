...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResidencePermit")]
    public partial class ResidencePermit : IEquatable<ResidencePermit>, IValidatableObject
    {

        /// <summary>
        /// &lt;br&gt;FREG: Oppholdstillatelse
        /// </summary>
        /// <value>&lt;br&gt;FREG: Oppholdstillatelse</value>
        [DataMember(Name = "residencePermitType", EmitDefaultValue = false)]
        public ResidencePermitType? ResidencePermitType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResidencePermit" /> class.
        /// </summary>
        ...
        /// <param name="residencePermitType">&lt;br&gt;FREG: Oppholdstillatelse.</param>
        /// <param name="stayFrom">&lt;br&gt;FREG: OppholdFra.</param>
        /// <param name="stayTo">&lt;br&gt;FREG: OppholdTil.</param>
        public ResidencePermit(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), ResidencePermitType? residencePermitType = default(ResidencePermitType?), DateTime? stayFrom = default(DateTime?), DateTime? stayTo = default(DateTime?))
        {
        ...
        /// &lt;br&gt;FREG: OppholdFra
        /// </summary>
        /// <value>&lt;br&gt;FREG: OppholdFra</value>
        [DataMember(Name = "stayFrom", EmitDefaultValue = true)]
        public DateTime? StayFrom { get; set; }

        /// <summary>
        /// &lt;br&gt;FREG: OppholdTil
        /// </summary>
        /// <value>&lt;br&gt;FREG: OppholdTil</value>
        [DataMember(Name = "stayTo", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResidencePermitType: ").Append(ResidencePermitType).Append("\n");
            sb.Append("  StayFrom: ").Append(StayFrom).Append("\n");
            sb.Append("  StayTo: ").Append(StayTo).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ResidencePermit);
        }

        /// <summary>
        /// Returns true if ResidencePermit instances are equal
        /// </summary>
        /// <param name="input">Instance of ResidencePermit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResidencePermit input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ResidencePermitType == input.ResidencePermitType ||
                    this.ResidencePermitType.Equals(input.ResidencePermitType)
                ) && 
                (
                    this.StayFrom == input.StayFrom ||
                    (this.StayFrom != null &&
                    this.StayFrom.Equals(input.StayFrom))
                ) && 
                (
                    this.StayTo == input.StayTo ||
                    (this.StayTo != null &&
                    this.StayTo.Equals(input.StayTo))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ResidencePermitType.GetHashCode();
                if (this.StayFrom != null)
                {
                    hashCode = (hashCode * 59) + this.StayFrom.GetHashCode();
                }
                if (this.StayTo != null)
                {
                    hashCode = (hashCode * 59) + this.StayTo.GetHashCode();
                }
                return hashCode;
            }
        }
