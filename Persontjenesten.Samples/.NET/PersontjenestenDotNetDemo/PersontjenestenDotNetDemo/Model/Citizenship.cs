...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Citizenship")]
    public partial class Citizenship : IEquatable<Citizenship>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Citizenship" /> class.
        /// </summary>
        ...
        /// <param name="countryCode">The country code, given in ISO 3166-1 alpha 3  &lt;br&gt;FREG: Statsborgerskap.</param>
        /// <param name="aquiredDate">&lt;br&gt;FREG: Ervervsdato.</param>
        public Citizenship(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), string countryCode = default(string), DateTime? aquiredDate = default(DateTime?))
        {
        ...
        /// </summary>
        /// <value>The country code, given in ISO 3166-1 alpha 3  &lt;br&gt;FREG: Statsborgerskap</value>
        ...
        /// &lt;br&gt;FREG: Ervervsdato
        /// </summary>
        /// <value>&lt;br&gt;FREG: Ervervsdato</value>
        [DataMember(Name = "aquiredDate", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AquiredDate: ").Append(AquiredDate).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as Citizenship);
        }

        /// <summary>
        /// Returns true if Citizenship instances are equal
        /// </summary>
        /// <param name="input">Instance of Citizenship to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Citizenship input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AquiredDate == input.AquiredDate ||
                    (this.AquiredDate != null &&
                    this.AquiredDate.Equals(input.AquiredDate))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AquiredDate != null)
                {
                    hashCode = (hashCode * 59) + this.AquiredDate.GetHashCode();
                }
                return hashCode;
            }
        }
