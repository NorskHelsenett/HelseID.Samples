...
namespace Org.OpenAPITools.Model
{
    ...
    /// &lt;br&gt;KRR: digital_post
    /// </summary>
    [DataContract(Name = "DigitalPostResource")]
    public partial class DigitalPostResource : IEquatable<DigitalPostResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DigitalPostResource" /> class.
        /// </summary>
        ...
        public DigitalPostResource(string digitalPostAddress = default(string), string digitalPostVendorAddress = default(string))
        {
        ...
        {
            return this.Equals(input as DigitalPostResource);
        }

        /// <summary>
        /// Returns true if DigitalPostResource instances are equal
        /// </summary>
        /// <param name="input">Instance of DigitalPostResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DigitalPostResource input)
        {
            if (input == null)
            {
                return false;
