...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostBoxAddress")]
    public partial class PostBoxAddress : IEquatable<PostBoxAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostBoxAddress" /> class.
        /// </summary>
        ...
        public PostBoxAddress(string postBoxOwner = default(string), string postBoxIdentification = default(string), CadastralAddressCity city = default(CadastralAddressCity))
        {
        ...
        {
            return this.Equals(input as PostBoxAddress);
        }

        /// <summary>
        /// Returns true if PostBoxAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of PostBoxAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostBoxAddress input)
        {
            if (input == null)
            {
                return false;
