...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResiduaryEstateContactInformation_contactAddress")]
    public partial class ResiduaryEstateContactInformationContactAddress : IEquatable<ResiduaryEstateContactInformationContactAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResiduaryEstateContactInformationContactAddress" /> class.
        /// </summary>
        ...
        public ResiduaryEstateContactInformationContactAddress(List<string> addressLine = default(List<string>), string city = default(string), string postalCode = default(string), string countryCode = default(string))
        {
        ...
        {
            return this.Equals(input as ResiduaryEstateContactInformationContactAddress);
        }

        /// <summary>
        /// Returns true if ResiduaryEstateContactInformationContactAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ResiduaryEstateContactInformationContactAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResiduaryEstateContactInformationContactAddress input)
        {
            if (input == null)
            {
                return false;
