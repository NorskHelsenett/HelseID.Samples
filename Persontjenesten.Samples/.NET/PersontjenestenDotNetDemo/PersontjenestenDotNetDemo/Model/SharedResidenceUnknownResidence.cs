...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SharedResidence_unknownResidence")]
    public partial class SharedResidenceUnknownResidence : IEquatable<SharedResidenceUnknownResidence>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SharedResidenceUnknownResidence" /> class.
        /// </summary>
        /// <param name="municipalityNumber">Persons adress is unknown, but the Municipality is known.  &lt;br&gt;FREG: Bostedskommune.</param>
        public SharedResidenceUnknownResidence(string municipalityNumber = default(string))
        {
        ...
        {
            return this.Equals(input as SharedResidenceUnknownResidence);
        }

        /// <summary>
        /// Returns true if SharedResidenceUnknownResidence instances are equal
        /// </summary>
        /// <param name="input">Instance of SharedResidenceUnknownResidence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SharedResidenceUnknownResidence input)
        {
            if (input == null)
            {
                return false;
