...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Death")]
    public partial class Death : IEquatable<Death>, IValidatableObject
    {
        /// <summary>
        ...
        public Death(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), DateTime? deceasedDate = default(DateTime?))
        {
        ...
        {
            return this.Equals(input as Death);
        }

        /// <summary>
        /// Returns true if Death instances are equal
        /// </summary>
        /// <param name="input">Instance of Death to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Death input)
        {
            if (input == null)
            {
                return false;
