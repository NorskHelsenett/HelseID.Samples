...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResidentialAddress_streetAddress")]
    public partial class ResidentialAddressStreetAddress : IEquatable<ResidentialAddressStreetAddress>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResidentialAddressStreetAddress" /> class.
        /// </summary>
        ...
        public ResidentialAddressStreetAddress(string municipalityNumber = default(string), string separatelyOccupiedUnitNumber = default(string), SeparatelyOccupiedUnitType? separatelyOccupiedUnitType = default(SeparatelyOccupiedUnitType?), string addressName = default(string), StreetAddressAddressNumber addressNumber = default(StreetAddressAddressNumber), string addressCode = default(string), string addressAdditionalName = default(string), CadastralAddressCity city = default(CadastralAddressCity), string coAddressName = default(string))
        {
        ...
        {
            return this.Equals(input as ResidentialAddressStreetAddress);
        }

        /// <summary>
        /// Returns true if ResidentialAddressStreetAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ResidentialAddressStreetAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResidentialAddressStreetAddress input)
        {
            if (input == null)
            {
                return false;
