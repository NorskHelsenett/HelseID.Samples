...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResiduaryEstateContactInformation_lawyer")]
    public partial class ResiduaryEstateContactInformationLawyer : IEquatable<ResiduaryEstateContactInformationLawyer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResiduaryEstateContactInformationLawyer" /> class.
        /// </summary>
        ...
        public ResiduaryEstateContactInformationLawyer(LawyerAsContactPersonName personName = default(LawyerAsContactPersonName), string organizationName = default(string), string organizationNumber = default(string))
        {
        ...
        public LawyerAsContactPersonName PersonName { get; set; }
        ...
        {
            return this.Equals(input as ResiduaryEstateContactInformationLawyer);
        }

        /// <summary>
        /// Returns true if ResiduaryEstateContactInformationLawyer instances are equal
        /// </summary>
        /// <param name="input">Instance of ResiduaryEstateContactInformationLawyer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResiduaryEstateContactInformationLawyer input)
        {
            if (input == null)
            {
                return false;
