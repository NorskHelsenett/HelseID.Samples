...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FreeFormInternationalAddress")]
    public partial class FreeFormInternationalAddress : IEquatable<FreeFormInternationalAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FreeFormInternationalAddress" /> class.
        /// </summary>
        ...
        public FreeFormInternationalAddress(List<string> addressLine = default(List<string>), string postCode = default(string), string cityOrPlaceName = default(string), string countryCode = default(string))
        {
        ...
        {
            return this.Equals(input as FreeFormInternationalAddress);
        }

        /// <summary>
        /// Returns true if FreeFormInternationalAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of FreeFormInternationalAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FreeFormInternationalAddress input)
        {
            if (input == null)
            {
                return false;
