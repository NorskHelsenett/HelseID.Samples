...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UnknownResidence")]
    public partial class UnknownResidence : IEquatable<UnknownResidence>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnknownResidence" /> class.
        /// </summary>
        /// <param name="municipalityNumber">Persons adress is unknown, but the Municipality is known.  &lt;br&gt;FREG: Bostedskommune.</param>
        public UnknownResidence(string municipalityNumber = default(string))
        {
        ...
        {
            return this.Equals(input as UnknownResidence);
        }

        /// <summary>
        /// Returns true if UnknownResidence instances are equal
        /// </summary>
        /// <param name="input">Instance of UnknownResidence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnknownResidence input)
        {
            if (input == null)
            {
                return false;
