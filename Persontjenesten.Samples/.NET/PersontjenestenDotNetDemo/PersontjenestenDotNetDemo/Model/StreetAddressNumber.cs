...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StreetAddressNumber")]
    public partial class StreetAddressNumber : IEquatable<StreetAddressNumber>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreetAddressNumber" /> class.
        /// </summary>
        ...
        public StreetAddressNumber(string houseNumber = default(string), string houseLetter = default(string))
        {
        ...
        {
            return this.Equals(input as StreetAddressNumber);
        }

        /// <summary>
        /// Returns true if StreetAddressNumber instances are equal
        /// </summary>
        /// <param name="input">Instance of StreetAddressNumber to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StreetAddressNumber input)
        {
            if (input == null)
            {
                return false;
