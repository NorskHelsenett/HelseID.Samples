...
namespace Org.OpenAPITools.Model
{
    ...
    public enum SeparatelyOccupiedUnitType
    {
        ...
        /// <summary>
        /// Enum OtherThanHousing for value: OtherThanHousing
        /// </summary>
        [EnumMember(Value = "OtherThanHousing")]
        OtherThanHousing = 2,

        /// <summary>
        /// Enum HolidayHome for value: HolidayHome
        /// </summary>
        [EnumMember(Value = "HolidayHome")]
        HolidayHome = 3,

        /// <summary>
        /// Enum NotApprovedAsHousing for value: NotApprovedAsHousing
        /// </summary>
        [EnumMember(Value = "NotApprovedAsHousing")]
        NotApprovedAsHousing = 4,

        /// <summary>
        /// Enum UnnumberedSeparatelyOccupiedUnit for value: UnnumberedSeparatelyOccupiedUnit
        /// </summary>
        [EnumMember(Value = "UnnumberedSeparatelyOccupiedUnit")]
        UnnumberedSeparatelyOccupiedUnit = 5
