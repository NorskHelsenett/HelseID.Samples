...
namespace Org.OpenAPITools.Model
{
    ...
    {
        /// <summary>
        /// Enum ImmigrationPersonalAndFinancialInterests for value: ImmigrationPersonalAndFinancialInterests
        /// </summary>
        [EnumMember(Value = "ImmigrationPersonalAndFinancialInterests")]
        ImmigrationPersonalAndFinancialInterests = 1,

        /// <summary>
        /// Enum PersonalAndFinancialInterests for value: PersonalAndFinancialInterests
        /// </summary>
        [EnumMember(Value = "PersonalAndFinancialInterests")]
        PersonalAndFinancialInterests = 2,

        /// <summary>
        /// Enum FinancialInterests for value: FinancialInterests
        /// </summary>
        [EnumMember(Value = "FinancialInterests")]
        FinancialInterests = 3,

        /// <summary>
        /// Enum PersonalInterests for value: PersonalInterests
        /// </summary>
        [EnumMember(Value = "PersonalInterests")]
        PersonalInterests = 4
