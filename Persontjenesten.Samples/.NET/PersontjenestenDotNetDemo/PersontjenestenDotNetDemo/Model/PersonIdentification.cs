...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonIdentification")]
    public partial class PersonIdentification : IEquatable<PersonIdentification>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="identificationNumber">The identification number  &lt;br&gt;FREG: Identifikasjonsnummer.</param>
        /// <param name="identificationNumberType">Type of foreign identification  Possible values:  - utenlandskIdentifikasjonsnummer &#x3D; Foreign identification number  - taxIdentificationNumber &#x3D; Tax Identification Number(TIN)  - socialSecurityNumber &#x3D; Social Security Number(SSN)  - utlendingsmyndighetenesIdentifikasjonsnummer &#x3D; \&quot;DUF-nummer\&quot; from the Norwegian UDI, for now  &lt;br&gt;FREG: Identifikasjonsnummertype.</param>
        /// <param name="issuerCountry">Country codes given in ISO 3166-1 Alpha 3  Always NOR for Person.ImmigrationAuthoritiesIdentificationNumber  XXK &#x3D; Kosovo  &lt;br&gt;FREG: Utstederland.</param>
        public PersonIdentification(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), string identificationNumber = default(string), string identificationNumberType = default(string), string issuerCountry = default(string))
        {
        ...
        /// </summary>
        /// <value>The identification number  &lt;br&gt;FREG: Identifikasjonsnummer</value>
        ...
        /// </summary>
        /// <value>Type of foreign identification  Possible values:  - utenlandskIdentifikasjonsnummer &#x3D; Foreign identification number  - taxIdentificationNumber &#x3D; Tax Identification Number(TIN)  - socialSecurityNumber &#x3D; Social Security Number(SSN)  - utlendingsmyndighetenesIdentifikasjonsnummer &#x3D; \&quot;DUF-nummer\&quot; from the Norwegian UDI, for now  &lt;br&gt;FREG: Identifikasjonsnummertype</value>
        [DataMember(Name = "identificationNumberType", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Country codes given in ISO 3166-1 Alpha 3  Always NOR for Person.ImmigrationAuthoritiesIdentificationNumber  XXK &#x3D; Kosovo  &lt;br&gt;FREG: Utstederland</value>
        ...
        {
            return this.Equals(input as PersonIdentification);
        }

        /// <summary>
        /// Returns true if PersonIdentification instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonIdentification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonIdentification input)
        {
            if (input == null)
            {
                return false;
