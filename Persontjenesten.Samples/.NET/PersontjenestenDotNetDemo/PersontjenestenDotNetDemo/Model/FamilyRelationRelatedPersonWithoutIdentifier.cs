...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FamilyRelation_relatedPersonWithoutIdentifier")]
    public partial class FamilyRelationRelatedPersonWithoutIdentifier : IEquatable<FamilyRelationRelatedPersonWithoutIdentifier>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FamilyRelationRelatedPersonWithoutIdentifier" /> class.
        /// </summary>
        ...
        public FamilyRelationRelatedPersonWithoutIdentifier(GuardianOrProxyName name = default(GuardianOrProxyName), DateTime? birthDate = default(DateTime?), string citizenship = default(string), Gender? gender = default(Gender?))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as FamilyRelationRelatedPersonWithoutIdentifier);
        }

        /// <summary>
        /// Returns true if FamilyRelationRelatedPersonWithoutIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of FamilyRelationRelatedPersonWithoutIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FamilyRelationRelatedPersonWithoutIdentifier input)
        {
            if (input == null)
            {
                return false;
