...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GuardianOrProxy_nameBirthDate")]
    public partial class GuardianOrProxyNameBirthDate : IEquatable<GuardianOrProxyNameBirthDate>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GuardianOrProxyNameBirthDate" /> class.
        /// </summary>
        ...
        public GuardianOrProxyNameBirthDate(PersonAsContactPersonName name = default(PersonAsContactPersonName), DateTime? birthDate = default(DateTime?), string citizenship = default(string), Gender? gender = default(Gender?))
        {
            this.Name = name;
        ...
        public PersonAsContactPersonName Name { get; set; }
        ...
        {
            return this.Equals(input as GuardianOrProxyNameBirthDate);
        }

        /// <summary>
        /// Returns true if GuardianOrProxyNameBirthDate instances are equal
        /// </summary>
        /// <param name="input">Instance of GuardianOrProxyNameBirthDate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GuardianOrProxyNameBirthDate input)
        {
            if (input == null)
            {
                return false;
