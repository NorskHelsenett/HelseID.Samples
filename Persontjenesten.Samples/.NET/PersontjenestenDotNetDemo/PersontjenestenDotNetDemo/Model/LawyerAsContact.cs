...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LawyerAsContact")]
    public partial class LawyerAsContact : IEquatable<LawyerAsContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LawyerAsContact" /> class.
        /// </summary>
        ...
        public LawyerAsContact(LawyerAsContactPersonName personName = default(LawyerAsContactPersonName), string organizationName = default(string), string organizationNumber = default(string))
        {
        ...
        {
            return this.Equals(input as LawyerAsContact);
        }

        /// <summary>
        /// Returns true if LawyerAsContact instances are equal
        /// </summary>
        /// <param name="input">Instance of LawyerAsContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LawyerAsContact input)
        {
            if (input == null)
            {
                return false;
