...
/**
 * API tests for EventNoLegalBasisApi
 */
@Disabled
public class EventNoLegalBasisApiTest {

    private final EventNoLegalBasisApi api = new EventNoLegalBasisApi();
     ...
     */
    @Test
    public void apiNoLegalBasisEventLatestGetTest() throws ApiException {
        String apiVersion = null;
        EventDocument response = api.apiNoLegalBasisEventLatestGet(apiVersion);
     ...
     */
    @Test
    public void eventNoLegalBasisTest() throws ApiException {
        String apiVersion = null;
        Long sequenceNumber = null;
        List<EventType> eventTypes = null;
        EventDocumentSearchResult response = api.eventNoLegalBasis(apiVersion, sequenceNumber, eventTypes);
        // TODO: test validations
    }
