...
import org.openapitools.client.model.SharedResidenceCadastralAddress;
import org.openapitools.client.model.SharedResidenceStreetAddress;
import org.openapitools.client.model.SharedResidenceUnknownResidence;
...
public class SharedResidence {
  ...
  private SharedResidenceStreetAddress streetAddress;
  ...
  private SharedResidenceCadastralAddress cadastralAddress;
  ...
  private SharedResidenceUnknownResidence unknownResidence;

  public static final String SERIALIZED_NAME_CONTRACT_VALID_FROM = "contractValidFrom";
  @SerializedName(SERIALIZED_NAME_CONTRACT_VALID_FROM)
  private OffsetDateTime contractValidFrom;

  public static final String SERIALIZED_NAME_CONTRACT_VALID_TO = "contractValidTo";
  @SerializedName(SERIALIZED_NAME_CONTRACT_VALID_TO)
  private OffsetDateTime contractValidTo;
  ...
  public SharedResidence() {
  }

  public SharedResidence registeredAt(OffsetDateTime registeredAt) {
  ...
  **/
  ...
  public SharedResidence isValid(Boolean isValid) {
  ...
  **/
  ...
  public SharedResidence source(String source) {
    this.source = source;
    return this;
  }
  ...
  **/
  ...
  public SharedResidence reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  **/
  ...
  public SharedResidence validFrom(OffsetDateTime validFrom) {
  ...
  **/
  ...
  public SharedResidence validTo(OffsetDateTime validTo) {
  ...
  **/
  ...
  public SharedResidence streetAddress(SharedResidenceStreetAddress streetAddress) {
  ...
  **/
  @javax.annotation.Nullable
  public SharedResidenceStreetAddress getStreetAddress() {
    return streetAddress;
  }

  public void setStreetAddress(SharedResidenceStreetAddress streetAddress) {
    this.streetAddress = streetAddress;
  }


  public SharedResidence cadastralAddress(SharedResidenceCadastralAddress cadastralAddress) {
  ...
  **/
  @javax.annotation.Nullable
  public SharedResidenceCadastralAddress getCadastralAddress() {
    return cadastralAddress;
  }

  public void setCadastralAddress(SharedResidenceCadastralAddress cadastralAddress) {
    this.cadastralAddress = cadastralAddress;
  }


  public SharedResidence unknownResidence(SharedResidenceUnknownResidence unknownResidence) {
  ...
  **/
  @javax.annotation.Nullable
  public SharedResidenceUnknownResidence getUnknownResidence() {
    return unknownResidence;
  }

  public void setUnknownResidence(SharedResidenceUnknownResidence unknownResidence) {
    this.unknownResidence = unknownResidence;
  }


  public SharedResidence contractValidFrom(OffsetDateTime contractValidFrom) {
  ...
  **/
  @javax.annotation.Nullable
  public OffsetDateTime getContractValidFrom() {
    return contractValidFrom;
  }

  public void setContractValidFrom(OffsetDateTime contractValidFrom) {
    this.contractValidFrom = contractValidFrom;
  }


  public SharedResidence contractValidTo(OffsetDateTime contractValidTo) {
  ...
  **/
  @javax.annotation.Nullable
  public OffsetDateTime getContractValidTo() {
    return contractValidTo;
  }

  public void setContractValidTo(OffsetDateTime contractValidTo) {
    this.contractValidTo = contractValidTo;
  }


  public SharedResidence cadastralIdentifier(String cadastralIdentifier) {
  ...
  **/
  ...
  public SharedResidence closeCadastralIdentifier(String closeCadastralIdentifier) {
  ...
  **/
  ...
  public SharedResidence addressConfidentiality(AddressConfidentiality addressConfidentiality) {
  ...
  **/
  ...
  public SharedResidence urbanDistrictCode(String urbanDistrictCode) {
  ...
  **/
  ...
  public SharedResidence urbanDistrictName(String urbanDistrictName) {
  ...
  **/
  ...
  public SharedResidence geographicalUrbanDistrictCode(String geographicalUrbanDistrictCode) {
  ...
  **/
  ...
  public SharedResidence geographicalUrbanDistrictName(String geographicalUrbanDistrictName) {
  ...
  **/
  ...
  @Deprecated
  public SharedResidence basicStatisticalUnit(Long basicStatisticalUnit) {
    this.basicStatisticalUnit = basicStatisticalUnit;
    return this;
  }

   /**
   * Three to four digit code used to divide a municipality in small, stable geographical units,  used as basis for regional statistical analysis.  Should be interpreted as a four digit string with leading zero.  Value 401 means \&quot;0401\&quot; and so on. For shared residences, the basic statistical unit  is enriched by the Person API, derived from the street or cadastral address.
  ...
  **/
  ...
  public SharedResidence fullBasicStatisticalUnitNumber(String fullBasicStatisticalUnitNumber) {
  ...
  **/
  ...
  public SharedResidence basicStatisticalUnitName(String basicStatisticalUnitName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SharedResidence sharedResidence = (SharedResidence) o;
    return Objects.equals(this.registeredAt, sharedResidence.registeredAt) &&
        Objects.equals(this.isValid, sharedResidence.isValid) &&
        Objects.equals(this.source, sharedResidence.source) &&
        Objects.equals(this.reason, sharedResidence.reason) &&
        Objects.equals(this.validFrom, sharedResidence.validFrom) &&
        Objects.equals(this.validTo, sharedResidence.validTo) &&
        Objects.equals(this.streetAddress, sharedResidence.streetAddress) &&
        Objects.equals(this.cadastralAddress, sharedResidence.cadastralAddress) &&
        Objects.equals(this.unknownResidence, sharedResidence.unknownResidence) &&
        Objects.equals(this.contractValidFrom, sharedResidence.contractValidFrom) &&
        Objects.equals(this.contractValidTo, sharedResidence.contractValidTo) &&
        Objects.equals(this.cadastralIdentifier, sharedResidence.cadastralIdentifier) &&
        Objects.equals(this.closeCadastralIdentifier, sharedResidence.closeCadastralIdentifier) &&
        Objects.equals(this.addressConfidentiality, sharedResidence.addressConfidentiality) &&
        Objects.equals(this.urbanDistrictCode, sharedResidence.urbanDistrictCode) &&
        Objects.equals(this.urbanDistrictName, sharedResidence.urbanDistrictName) &&
        Objects.equals(this.geographicalUrbanDistrictCode, sharedResidence.geographicalUrbanDistrictCode) &&
        Objects.equals(this.geographicalUrbanDistrictName, sharedResidence.geographicalUrbanDistrictName) &&
        Objects.equals(this.basicStatisticalUnit, sharedResidence.basicStatisticalUnit) &&
        Objects.equals(this.fullBasicStatisticalUnitNumber, sharedResidence.fullBasicStatisticalUnitNumber) &&
        Objects.equals(this.basicStatisticalUnitName, sharedResidence.basicStatisticalUnitName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(registeredAt, isValid, source, reason, validFrom, validTo, streetAddress, cadastralAddress, unknownResidence, contractValidFrom, contractValidTo, cadastralIdentifier, closeCadastralIdentifier, addressConfidentiality, urbanDistrictCode, urbanDistrictName, geographicalUrbanDistrictCode, geographicalUrbanDistrictName, basicStatisticalUnit, fullBasicStatisticalUnitNumber, basicStatisticalUnitName);
  }
  ...
  public String toString() {
    ...
    sb.append("    contractValidFrom: ").append(toIndentedString(contractValidFrom)).append("\n");
    sb.append("    contractValidTo: ").append(toIndentedString(contractValidTo)).append("\n");
  ...
  static {
    ...
    openapiFields.add("contractValidFrom");
    openapiFields.add("contractValidTo");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SharedResidence
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SharedResidence.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SharedResidence is not found in the empty JSON string", SharedResidence.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SharedResidence.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SharedResidence` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SharedResidence.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SharedResidence' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SharedResidence> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SharedResidence.class));

       return (TypeAdapter<T>) new TypeAdapter<SharedResidence>() {
           @Override
           public void write(JsonWriter out, SharedResidence value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SharedResidence read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SharedResidence given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SharedResidence
  * @throws IOException if the JSON string is invalid with respect to SharedResidence
  */
  public static SharedResidence fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SharedResidence.class);
  }

 /**
  * Convert an instance of SharedResidence to an JSON string
  *
  * @return JSON string
  */
