...
public class SearchWithLegalBasisApi {
    ...
    /**
     * Build call for apiLegalBasisSearchMatchCountPost
    ...
    public okhttp3.Call apiLegalBasisSearchMatchCountPostCall(String apiVersion, Boolean includeAinResults, Integer pageSize, Integer indexOffset, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String municipalityNumber, String basicStatisticalUnit, String birthDateFrom, String birthDateTo, Gender gender, List<PersonStatusType> personStatuses, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/legal-basis/search/match-count";
    ...
    private okhttp3.Call apiLegalBasisSearchMatchCountPostValidateBeforeCall(String apiVersion, Boolean includeAinResults, Integer pageSize, Integer indexOffset, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String municipalityNumber, String basicStatisticalUnit, String birthDateFrom, String birthDateTo, Gender gender, List<PersonStatusType> personStatuses, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling apiLegalBasisSearchMatchCountPost(Async)");
        }

        return apiLegalBasisSearchMatchCountPostCall(apiVersion, includeAinResults, pageSize, indexOffset, fullName, givenName, middleName, familyName, streetAddress, postalCode, municipalityNumber, basicStatisticalUnit, birthDateFrom, birthDateTo, gender, personStatuses, _callback);
     ...
     */
    public SearchMatchCountResult apiLegalBasisSearchMatchCountPost(String apiVersion, Boolean includeAinResults, Integer pageSize, Integer indexOffset, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String municipalityNumber, String basicStatisticalUnit, String birthDateFrom, String birthDateTo, Gender gender, List<PersonStatusType> personStatuses) throws ApiException {
        ApiResponse<SearchMatchCountResult> localVarResp = apiLegalBasisSearchMatchCountPostWithHttpInfo(apiVersion, includeAinResults, pageSize, indexOffset, fullName, givenName, middleName, familyName, streetAddress, postalCode, municipalityNumber, basicStatisticalUnit, birthDateFrom, birthDateTo, gender, personStatuses);
     ...
     */
    public ApiResponse<SearchMatchCountResult> apiLegalBasisSearchMatchCountPostWithHttpInfo(String apiVersion, Boolean includeAinResults, Integer pageSize, Integer indexOffset, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String municipalityNumber, String basicStatisticalUnit, String birthDateFrom, String birthDateTo, Gender gender, List<PersonStatusType> personStatuses) throws ApiException {
        okhttp3.Call localVarCall = apiLegalBasisSearchMatchCountPostValidateBeforeCall(apiVersion, includeAinResults, pageSize, indexOffset, fullName, givenName, middleName, familyName, streetAddress, postalCode, municipalityNumber, basicStatisticalUnit, birthDateFrom, birthDateTo, gender, personStatuses, null);
        Type localVarReturnType = new TypeToken<SearchMatchCountResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Works same way as \&quot;paged-match-list\&quot; regarding search parameters, but returned result is just the total count of matches that would have been returned.  Use it to predict how many matches a search with search/paged-match-list endpoint would have returned without fetching full set of data. (asynchronously)
     * See documentation for \&quot;paged-match-list\&quot; for more details.&lt;br /&gt;&lt;br /&gt;&lt;b&gt;Requires HelseId scope:&lt;/b&gt; ReadWithLegalBasis
     * @param apiVersion The requested API version (required)
     * @param includeAinResults flag to determine if search results should include persons with alternate identification numbers (optional, default to false)
     * @param pageSize The maximum size of the returned result set. Defaults to 1000, max page size is 10000.  When the returned result set is less then the requested page size then you have reached the end of the total search result. (optional, default to 1000)
     ...
     */
    public okhttp3.Call apiLegalBasisSearchMatchCountPostAsync(String apiVersion, Boolean includeAinResults, Integer pageSize, Integer indexOffset, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String municipalityNumber, String basicStatisticalUnit, String birthDateFrom, String birthDateTo, Gender gender, List<PersonStatusType> personStatuses, final ApiCallback<SearchMatchCountResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiLegalBasisSearchMatchCountPostValidateBeforeCall(apiVersion, includeAinResults, pageSize, indexOffset, fullName, givenName, middleName, familyName, streetAddress, postalCode, municipalityNumber, basicStatisticalUnit, birthDateFrom, birthDateTo, gender, personStatuses, _callback);
        Type localVarReturnType = new TypeToken<SearchMatchCountResult>(){}.getType();
    ...
    private okhttp3.Call apiLegalBasisSearchMatchListPostValidateBeforeCall(String apiVersion, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String municipalityNumber, String basicStatisticalUnit, String birthDateFrom, String birthDateTo, Gender gender, List<PersonStatusType> personStatuses, final ApiCallback _callback) throws ApiException {
        ...
        return apiLegalBasisSearchMatchListPostCall(apiVersion, fullName, givenName, middleName, familyName, streetAddress, postalCode, municipalityNumber, basicStatisticalUnit, birthDateFrom, birthDateTo, gender, personStatuses, _callback);
     ...
     */
    @Deprecated
    public List<String> apiLegalBasisSearchMatchListPost(String apiVersion, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String municipalityNumber, String basicStatisticalUnit, String birthDateFrom, String birthDateTo, Gender gender, List<PersonStatusType> personStatuses) throws ApiException {
        ApiResponse<List<String>> localVarResp = apiLegalBasisSearchMatchListPostWithHttpInfo(apiVersion, fullName, givenName, middleName, familyName, streetAddress, postalCode, municipalityNumber, basicStatisticalUnit, birthDateFrom, birthDateTo, gender, personStatuses);
        return localVarResp.getData();
    }
     ...
     */
    @Deprecated
    public ApiResponse<List<String>> apiLegalBasisSearchMatchListPostWithHttpInfo(String apiVersion, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String municipalityNumber, String basicStatisticalUnit, String birthDateFrom, String birthDateTo, Gender gender, List<PersonStatusType> personStatuses) throws ApiException {
        okhttp3.Call localVarCall = apiLegalBasisSearchMatchListPostValidateBeforeCall(apiVersion, fullName, givenName, middleName, familyName, streetAddress, postalCode, municipalityNumber, basicStatisticalUnit, birthDateFrom, birthDateTo, gender, personStatuses, null);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Search for a set of persons based on current information. Returns a list with unique person ids, see HgdPerson.Out.OpenApi.Model.Person (asynchronously)
     * Search for a set of persons based on current information. Returns a list with unique person ids, see Person&lt;br /&gt;&lt;br /&gt;&lt;b&gt;Requires HelseId scope:&lt;/b&gt; ReadWithLegalBasis
     * @param apiVersion The requested API version (required)
     * @param fullName The whole or parts of a person&#39;s full name. Only letters are allowed, up to 600 characters.  The search string will be divided into separate search words, and these words can match  the start of any part of the person&#39;s full name, regardless of the order of search words.  Only the first three search words will be used. (optional)
     * @param givenName The whole or the first part of a person&#39;s given name.  Only letters are allowed, up to 200 characters. (optional)
    ...
    public okhttp3.Call apiLegalBasisSearchMatchListPostAsync(String apiVersion, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String municipalityNumber, String basicStatisticalUnit, String birthDateFrom, String birthDateTo, Gender gender, List<PersonStatusType> personStatuses, final ApiCallback<List<String>> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = apiLegalBasisSearchMatchListPostValidateBeforeCall(apiVersion, fullName, givenName, middleName, familyName, streetAddress, postalCode, municipalityNumber, basicStatisticalUnit, birthDateFrom, birthDateTo, gender, personStatuses, _callback);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for apiLegalBasisSearchPagedMatchListPost
     * @param apiVersion The requested API version (required)
     * @param includeAinResults flag to determine if search results should include persons with alternate identification numbers (optional, default to false)
     * @param pageSize The maximum size of the returned result set. Defaults to 1000, max page size is 10000.  When the returned result set is less then the requested page size then you have reached the end of the total search result. (optional, default to 1000)
     * @param indexOffset The index offset for the search. A paged-match-list search will return both a startIndex and endIndex in the response.  If the number of search results is larger than the page size, the next portion of the result can be retrieved by setting the  index offset to the end index of the first result, plus one (endIndex + 1). (optional, default to 0)
     ...
     */
    public okhttp3.Call apiLegalBasisSearchPagedMatchListPostCall(String apiVersion, Boolean includeAinResults, Integer pageSize, Integer indexOffset, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String municipalityNumber, String basicStatisticalUnit, String birthDateFrom, String birthDateTo, Gender gender, List<PersonStatusType> personStatuses, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/legal-basis/search/paged-match-list";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiLegalBasisSearchPagedMatchListPostValidateBeforeCall(String apiVersion, Boolean includeAinResults, Integer pageSize, Integer indexOffset, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String municipalityNumber, String basicStatisticalUnit, String birthDateFrom, String birthDateTo, Gender gender, List<PersonStatusType> personStatuses, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiVersion' is set
        if (apiVersion == null) {
            throw new ApiException("Missing the required parameter 'apiVersion' when calling apiLegalBasisSearchPagedMatchListPost(Async)");
        }

        return apiLegalBasisSearchPagedMatchListPostCall(apiVersion, includeAinResults, pageSize, indexOffset, fullName, givenName, middleName, familyName, streetAddress, postalCode, municipalityNumber, basicStatisticalUnit, birthDateFrom, birthDateTo, gender, personStatuses, _callback);
     ...
     */
    public StringSearchResult apiLegalBasisSearchPagedMatchListPost(String apiVersion, Boolean includeAinResults, Integer pageSize, Integer indexOffset, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String municipalityNumber, String basicStatisticalUnit, String birthDateFrom, String birthDateTo, Gender gender, List<PersonStatusType> personStatuses) throws ApiException {
        ApiResponse<StringSearchResult> localVarResp = apiLegalBasisSearchPagedMatchListPostWithHttpInfo(apiVersion, includeAinResults, pageSize, indexOffset, fullName, givenName, middleName, familyName, streetAddress, postalCode, municipalityNumber, basicStatisticalUnit, birthDateFrom, birthDateTo, gender, personStatuses);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<StringSearchResult> apiLegalBasisSearchPagedMatchListPostWithHttpInfo(String apiVersion, Boolean includeAinResults, Integer pageSize, Integer indexOffset, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String municipalityNumber, String basicStatisticalUnit, String birthDateFrom, String birthDateTo, Gender gender, List<PersonStatusType> personStatuses) throws ApiException {
        okhttp3.Call localVarCall = apiLegalBasisSearchPagedMatchListPostValidateBeforeCall(apiVersion, includeAinResults, pageSize, indexOffset, fullName, givenName, middleName, familyName, streetAddress, postalCode, municipalityNumber, basicStatisticalUnit, birthDateFrom, birthDateTo, gender, personStatuses, null);
     ...
     */
    public okhttp3.Call apiLegalBasisSearchPagedMatchListPostAsync(String apiVersion, Boolean includeAinResults, Integer pageSize, Integer indexOffset, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String municipalityNumber, String basicStatisticalUnit, String birthDateFrom, String birthDateTo, Gender gender, List<PersonStatusType> personStatuses, final ApiCallback<StringSearchResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiLegalBasisSearchPagedMatchListPostValidateBeforeCall(apiVersion, includeAinResults, pageSize, indexOffset, fullName, givenName, middleName, familyName, streetAddress, postalCode, municipalityNumber, basicStatisticalUnit, birthDateFrom, birthDateTo, gender, personStatuses, _callback);
        Type localVarReturnType = new TypeToken<StringSearchResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call apiLegalBasisSearchPersonPostCall(List<InformationPart> informationParts, String apiVersion, Boolean includeHistory, Boolean includeAinResults, String birthDate, Gender gender, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String cityName, String municipalityNumber, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiLegalBasisSearchPersonPostValidateBeforeCall(List<InformationPart> informationParts, String apiVersion, Boolean includeHistory, Boolean includeAinResults, String birthDate, Gender gender, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String cityName, String municipalityNumber, final ApiCallback _callback) throws ApiException {
        ...
        return apiLegalBasisSearchPersonPostCall(informationParts, apiVersion, includeHistory, includeAinResults, birthDate, gender, fullName, givenName, middleName, familyName, streetAddress, postalCode, cityName, municipalityNumber, _callback);
     ...
     */
    public PersonSearchResult apiLegalBasisSearchPersonPost(List<InformationPart> informationParts, String apiVersion, Boolean includeHistory, Boolean includeAinResults, String birthDate, Gender gender, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String cityName, String municipalityNumber) throws ApiException {
        ApiResponse<PersonSearchResult> localVarResp = apiLegalBasisSearchPersonPostWithHttpInfo(informationParts, apiVersion, includeHistory, includeAinResults, birthDate, gender, fullName, givenName, middleName, familyName, streetAddress, postalCode, cityName, municipalityNumber);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PersonSearchResult> apiLegalBasisSearchPersonPostWithHttpInfo(List<InformationPart> informationParts, String apiVersion, Boolean includeHistory, Boolean includeAinResults, String birthDate, Gender gender, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String cityName, String municipalityNumber) throws ApiException {
        okhttp3.Call localVarCall = apiLegalBasisSearchPersonPostValidateBeforeCall(informationParts, apiVersion, includeHistory, includeAinResults, birthDate, gender, fullName, givenName, middleName, familyName, streetAddress, postalCode, cityName, municipalityNumber, null);
     ...
     */
    public okhttp3.Call apiLegalBasisSearchPersonPostAsync(List<InformationPart> informationParts, String apiVersion, Boolean includeHistory, Boolean includeAinResults, String birthDate, Gender gender, String fullName, String givenName, String middleName, String familyName, String streetAddress, String postalCode, String cityName, String municipalityNumber, final ApiCallback<PersonSearchResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiLegalBasisSearchPersonPostValidateBeforeCall(informationParts, apiVersion, includeHistory, includeAinResults, birthDate, gender, fullName, givenName, middleName, familyName, streetAddress, postalCode, cityName, municipalityNumber, _callback);
        Type localVarReturnType = new TypeToken<PersonSearchResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
