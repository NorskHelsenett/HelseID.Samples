...
public class PresentAddressStreetAddress {
  ...
  public PresentAddressStreetAddress() {
  }

  public PresentAddressStreetAddress municipalityNumber(String municipalityNumber) {
  ...
  **/
  ...
  public PresentAddressStreetAddress municipalityName(String municipalityName) {
  ...
  **/
  ...
  public PresentAddressStreetAddress countyNumber(String countyNumber) {
  ...
  **/
  ...
  public PresentAddressStreetAddress countyName(String countyName) {
  ...
  **/
  ...
  public PresentAddressStreetAddress separatelyOccupiedUnitNumber(String separatelyOccupiedUnitNumber) {
  ...
  **/
  ...
  public PresentAddressStreetAddress separatelyOccupiedUnitType(SeparatelyOccupiedUnitType separatelyOccupiedUnitType) {
  ...
  **/
  ...
  public PresentAddressStreetAddress addressName(String addressName) {
  ...
  **/
  ...
  public PresentAddressStreetAddress addressNumber(StreetAddressAddressNumber addressNumber) {
  ...
  **/
  ...
  public PresentAddressStreetAddress addressCode(String addressCode) {
  ...
  **/
  ...
  public PresentAddressStreetAddress addressAdditionalName(String addressAdditionalName) {
  ...
  **/
  ...
  public PresentAddressStreetAddress city(CadastralAddressCity city) {
    this.city = city;
    return this;
  }
  ...
  **/
  ...
  public PresentAddressStreetAddress coAddressName(String coAddressName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PresentAddressStreetAddress presentAddressStreetAddress = (PresentAddressStreetAddress) o;
    return Objects.equals(this.municipalityNumber, presentAddressStreetAddress.municipalityNumber) &&
        Objects.equals(this.municipalityName, presentAddressStreetAddress.municipalityName) &&
        Objects.equals(this.countyNumber, presentAddressStreetAddress.countyNumber) &&
        Objects.equals(this.countyName, presentAddressStreetAddress.countyName) &&
        Objects.equals(this.separatelyOccupiedUnitNumber, presentAddressStreetAddress.separatelyOccupiedUnitNumber) &&
        Objects.equals(this.separatelyOccupiedUnitType, presentAddressStreetAddress.separatelyOccupiedUnitType) &&
        Objects.equals(this.addressName, presentAddressStreetAddress.addressName) &&
        Objects.equals(this.addressNumber, presentAddressStreetAddress.addressNumber) &&
        Objects.equals(this.addressCode, presentAddressStreetAddress.addressCode) &&
        Objects.equals(this.addressAdditionalName, presentAddressStreetAddress.addressAdditionalName) &&
        Objects.equals(this.city, presentAddressStreetAddress.city) &&
        Objects.equals(this.coAddressName, presentAddressStreetAddress.coAddressName);
  }
  ...
  public String toString() {
    ...
    sb.append("class PresentAddressStreetAddress {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to PresentAddressStreetAddress
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PresentAddressStreetAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PresentAddressStreetAddress is not found in the empty JSON string", PresentAddressStreetAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PresentAddressStreetAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PresentAddressStreetAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PresentAddressStreetAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PresentAddressStreetAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PresentAddressStreetAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PresentAddressStreetAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<PresentAddressStreetAddress>() {
           @Override
           public void write(JsonWriter out, PresentAddressStreetAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PresentAddressStreetAddress read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PresentAddressStreetAddress given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PresentAddressStreetAddress
  * @throws IOException if the JSON string is invalid with respect to PresentAddressStreetAddress
  */
  public static PresentAddressStreetAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PresentAddressStreetAddress.class);
  }

 /**
  * Convert an instance of PresentAddressStreetAddress to an JSON string
  *
  * @return JSON string
  */
