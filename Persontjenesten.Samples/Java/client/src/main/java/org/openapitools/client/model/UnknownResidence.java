...
/**
 * Person has an unknown address  &lt;br&gt;FREG: UkjentBosted
 */
...
public class UnknownResidence {
  ...
  public UnknownResidence() {
  }

  public UnknownResidence municipalityNumber(String municipalityNumber) {
  ...
  **/
  ...
  public UnknownResidence municipalityName(String municipalityName) {
  ...
  **/
  ...
  public UnknownResidence countyNumber(String countyNumber) {
  ...
  **/
  ...
  public UnknownResidence countyName(String countyName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UnknownResidence unknownResidence = (UnknownResidence) o;
    return Objects.equals(this.municipalityNumber, unknownResidence.municipalityNumber) &&
        Objects.equals(this.municipalityName, unknownResidence.municipalityName) &&
        Objects.equals(this.countyNumber, unknownResidence.countyNumber) &&
        Objects.equals(this.countyName, unknownResidence.countyName);
  }
  ...
  public String toString() {
    ...
    sb.append("class UnknownResidence {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UnknownResidence
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnknownResidence.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnknownResidence is not found in the empty JSON string", UnknownResidence.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnknownResidence.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnknownResidence` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnknownResidence.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnknownResidence' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnknownResidence> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnknownResidence.class));

       return (TypeAdapter<T>) new TypeAdapter<UnknownResidence>() {
           @Override
           public void write(JsonWriter out, UnknownResidence value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnknownResidence read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UnknownResidence given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UnknownResidence
  * @throws IOException if the JSON string is invalid with respect to UnknownResidence
  */
  public static UnknownResidence fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnknownResidence.class);
  }

 /**
  * Convert an instance of UnknownResidence to an JSON string
  *
  * @return JSON string
  */
