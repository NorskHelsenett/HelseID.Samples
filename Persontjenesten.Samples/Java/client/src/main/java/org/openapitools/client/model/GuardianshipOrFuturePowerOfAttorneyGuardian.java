...
public class GuardianshipOrFuturePowerOfAttorneyGuardian {
  ...
  **/
  ...
  public GuardianshipOrFuturePowerOfAttorneyGuardian guardianInformation(GuardianOrProxyGuardianInformation guardianInformation) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, guardianshipOrFuturePowerOfAttorneyGuardian.name) &&
        ...
        Objects.equals(this.guardianInformation, guardianshipOrFuturePowerOfAttorneyGuardian.guardianInformation) &&
  ...
  * @throws IOException if the JSON Element is invalid with respect to GuardianshipOrFuturePowerOfAttorneyGuardian
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GuardianshipOrFuturePowerOfAttorneyGuardian.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GuardianshipOrFuturePowerOfAttorneyGuardian.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GuardianshipOrFuturePowerOfAttorneyGuardian` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
