...
public class CadastralNumber {
  ...
  **/
  ...
  public CadastralNumber municipalityName(String municipalityName) {
  ...
  **/
  ...
  public CadastralNumber countyNumber(String countyNumber) {
  ...
  **/
  ...
  public CadastralNumber countyName(String countyName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.municipalityNumber, cadastralNumber.municipalityNumber) &&
        Objects.equals(this.municipalityName, cadastralNumber.municipalityName) &&
        Objects.equals(this.countyNumber, cadastralNumber.countyNumber) &&
        Objects.equals(this.countyName, cadastralNumber.countyName) &&
  ...
  * @throws IOException if the JSON Element is invalid with respect to CadastralNumber
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CadastralNumber.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CadastralNumber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CadastralNumber` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
