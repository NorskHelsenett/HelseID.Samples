...
Information on a persons death.  <br>FREG: Doedsfall
...
|**deceasedDate** | **OffsetDateTime** | The date when the person was declared dead. Time and time zone are unknown and must be ignored.  &lt;br&gt;FREG: Doedsdato |  [optional] |
