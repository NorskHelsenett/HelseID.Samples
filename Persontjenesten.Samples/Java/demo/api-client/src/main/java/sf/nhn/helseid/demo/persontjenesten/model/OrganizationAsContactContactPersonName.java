 ...
 */
@ApiModel(description = "Contact person  <br>FREG: Kontaktpersonnavn")
...
public class OrganizationAsContactContactPersonName {
  ...
  public OrganizationAsContactContactPersonName() {
  }

  public OrganizationAsContactContactPersonName givenName(String givenName) {
  ...
  **/
  ...
  public OrganizationAsContactContactPersonName middleName(String middleName) {
  ...
  **/
  ...
  public OrganizationAsContactContactPersonName familyName(String familyName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OrganizationAsContactContactPersonName organizationAsContactContactPersonName = (OrganizationAsContactContactPersonName) o;
    return Objects.equals(this.givenName, organizationAsContactContactPersonName.givenName) &&
        Objects.equals(this.middleName, organizationAsContactContactPersonName.middleName) &&
        Objects.equals(this.familyName, organizationAsContactContactPersonName.familyName);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationAsContactContactPersonName {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrganizationAsContactContactPersonName
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (OrganizationAsContactContactPersonName.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationAsContactContactPersonName is not found in the empty JSON string", OrganizationAsContactContactPersonName.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OrganizationAsContactContactPersonName.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationAsContactContactPersonName` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationAsContactContactPersonName.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationAsContactContactPersonName' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationAsContactContactPersonName> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationAsContactContactPersonName.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationAsContactContactPersonName>() {
           @Override
           public void write(JsonWriter out, OrganizationAsContactContactPersonName value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationAsContactContactPersonName read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of OrganizationAsContactContactPersonName given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrganizationAsContactContactPersonName
  * @throws IOException if the JSON string is invalid with respect to OrganizationAsContactContactPersonName
  */
  public static OrganizationAsContactContactPersonName fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationAsContactContactPersonName.class);
  }

 /**
  * Convert an instance of OrganizationAsContactContactPersonName to an JSON string
  *
  * @return JSON string
  */
