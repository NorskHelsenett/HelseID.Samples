 ...
 */
@ApiModel(description = "<br>FREG: UtenlandskAdresse")
...
public class ForeignContactAddressForeignAddress {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ForeignContactAddressForeignAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ForeignContactAddressForeignAddress.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ForeignContactAddressForeignAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ForeignContactAddressForeignAddress` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
