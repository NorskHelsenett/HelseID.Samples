 ...
 * &lt;br&gt;FREG: Doedsfall
 */
@ApiModel(description = "<br>FREG: Doedsfall")
...
public class PersonDeath {
  ...
  public PersonDeath registeredAt(OffsetDateTime registeredAt) {
  ...
  **/
  ...
  public PersonDeath isValid(Boolean isValid) {
  ...
  **/
  ...
  public PersonDeath source(String source) {
  ...
  **/
  ...
  public PersonDeath reason(String reason) {
  ...
  **/
  ...
  public PersonDeath validFrom(OffsetDateTime validFrom) {
  ...
  **/
  ...
  public PersonDeath validTo(OffsetDateTime validTo) {
  ...
  **/
  ...
  public PersonDeath deceasedDate(OffsetDateTime deceasedDate) {
   ...
   /**
   * The date when the person was decleared dead.  &lt;br&gt;FREG: Doedsdato
   * @return deceasedDate
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the person was decleared dead.  <br>FREG: Doedsdato")

  public OffsetDateTime getDeceasedDate() {
    return deceasedDate;
  }


  public void setDeceasedDate(OffsetDateTime deceasedDate) {
    this.deceasedDate = deceasedDate;
  }
  ...
  public boolean equals(Object o) {
    ...
    PersonDeath personDeath = (PersonDeath) o;
    return Objects.equals(this.registeredAt, personDeath.registeredAt) &&
        Objects.equals(this.isValid, personDeath.isValid) &&
        Objects.equals(this.source, personDeath.source) &&
        Objects.equals(this.reason, personDeath.reason) &&
        Objects.equals(this.validFrom, personDeath.validFrom) &&
        Objects.equals(this.validTo, personDeath.validTo) &&
        Objects.equals(this.deceasedDate, personDeath.deceasedDate);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(registeredAt, isValid, source, reason, validFrom, validTo, deceasedDate);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PersonDeath
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PersonDeath.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonDeath is not found in the empty JSON string", PersonDeath.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PersonDeath.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonDeath` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PersonDeath.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PersonDeath' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PersonDeath> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PersonDeath.class));

       return (TypeAdapter<T>) new TypeAdapter<PersonDeath>() {
           @Override
           public void write(JsonWriter out, PersonDeath value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PersonDeath read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PersonDeath given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PersonDeath
  * @throws IOException if the JSON string is invalid with respect to PersonDeath
  */
  public static PersonDeath fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonDeath.class);
  }

 /**
  * Convert an instance of PersonDeath to an JSON string
  *
  * @return JSON string
  */
