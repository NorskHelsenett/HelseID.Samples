 ...
 */
@ApiModel(description = "Official numbering of each Cadastral  <br>FREG: Matrikkelnummer")
...
public class CadastralAddressCadastralNumber {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CadastralAddressCadastralNumber
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CadastralAddressCadastralNumber.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CadastralAddressCadastralNumber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CadastralAddressCadastralNumber` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
