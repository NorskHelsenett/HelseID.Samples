 ...
 */
@ApiModel(description = "Information regarding a persons residency on Svalbard  <br>FREG: OppholdPaaSvalbard")
...
public class StayOnSvalbard {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Startdato")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Sluttdato")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Fraflyttingskommunenummer")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Fraflyttingsland")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: AntallTidligereOpphold")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: AntattOppholdsvarighet")
  ...
  * @throws IOException if the JSON Object is invalid with respect to StayOnSvalbard
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (StayOnSvalbard.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StayOnSvalbard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StayOnSvalbard` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
