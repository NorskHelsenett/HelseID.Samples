 ...
 */
@ApiModel(description = "<br>FREG: RelatertBiPerson")
...
public class RelatedBiPerson {
  ...
  * @throws IOException if the JSON Object is invalid with respect to RelatedBiPerson
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (RelatedBiPerson.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RelatedBiPerson.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RelatedBiPerson` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
