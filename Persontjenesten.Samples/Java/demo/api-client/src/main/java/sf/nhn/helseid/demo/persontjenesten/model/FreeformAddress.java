 ...
 */
@ApiModel(description = "<br>FREG: AdresseIFrittFormat")
...
public class FreeformAddress {
  ...
  public FreeformAddress addressLine(List<String> addressLine) {
    
    this.addressLine = addressLine;
    return this;
  }

  public FreeformAddress addAddressLineItem(String addressLineItem) {
  ...
  **/
  ...
  public FreeformAddress countryCode(String countryCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addressLine, freeformAddress.addressLine) &&
        Objects.equals(this.countryCode, freeformAddress.countryCode);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FreeformAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (FreeformAddress.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in FreeformAddress is not found in the empty JSON string", FreeformAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FreeformAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FreeformAddress` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FreeformAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FreeformAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FreeformAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FreeformAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<FreeformAddress>() {
           @Override
           public void write(JsonWriter out, FreeformAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FreeformAddress read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of FreeformAddress given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FreeformAddress
  * @throws IOException if the JSON string is invalid with respect to FreeformAddress
  */
  public static FreeformAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FreeformAddress.class);
  }

 /**
  * Convert an instance of FreeformAddress to an JSON string
  *
  * @return JSON string
  */
