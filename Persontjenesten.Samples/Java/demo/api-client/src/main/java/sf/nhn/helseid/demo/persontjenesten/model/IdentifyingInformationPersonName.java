 ...
 * &lt;br&gt;FREG: Personnavn
 */
@ApiModel(description = "<br>FREG: Personnavn")
...
public class IdentifyingInformationPersonName {
  ...
  * @throws IOException if the JSON Object is invalid with respect to IdentifyingInformationPersonName
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (IdentifyingInformationPersonName.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!IdentifyingInformationPersonName.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IdentifyingInformationPersonName` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
