 ...
 */
@ApiModel(description = "<br>FREG: KontaktadresseIUtlandet")
...
public class ForeignContactAddress {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ForeignContactAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ForeignContactAddress.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ForeignContactAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ForeignContactAddress` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("freeFormForeignAddress") != null && !jsonObj.get("freeFormForeignAddress").isJsonNull()) {
        ForeignContactAddressFreeFormForeignAddress.validateJsonObject(jsonObj.getAsJsonObject("freeFormForeignAddress"));
      }
  }
