 ...
 */
@ApiModel(description = "FREG: FratattRettsligHandleevne")
...
public class DeprivedLegalAuthority {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeprivedLegalAuthority
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (DeprivedLegalAuthority.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DeprivedLegalAuthority.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeprivedLegalAuthority` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
