 ...
 */
@ApiModel(description = "The cadastral address  <br>Remarks:   May be missing, only one of the address elements are used. See ResidentialAddress  Freg: Matrikkeladresse")
...
public class ResidentialAddressCadastralAddress {
  ...
  public ResidentialAddressCadastralAddress() {
  }

  public ResidentialAddressCadastralAddress separatelyOccupiedUnitNumber(String separatelyOccupiedUnitNumber) {
  ...
  **/
  ...
  public ResidentialAddressCadastralAddress separatelyOccupiedUnitType(SeparatelyOccupiedUnitType separatelyOccupiedUnitType) {
  ...
  **/
  ...
  public ResidentialAddressCadastralAddress cadastralNumber(CadastralAddressCadastralNumber cadastralNumber) {
  ...
  **/
  ...
  public ResidentialAddressCadastralAddress subNumber(Long subNumber) {
  ...
  **/
  ...
  public ResidentialAddressCadastralAddress addressAdditionalName(String addressAdditionalName) {
  ...
  **/
  ...
  public ResidentialAddressCadastralAddress city(CadastralAddressCity city) {
  ...
  **/
  ...
  public ResidentialAddressCadastralAddress coAddressName(String coAddressName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ResidentialAddressCadastralAddress residentialAddressCadastralAddress = (ResidentialAddressCadastralAddress) o;
    return Objects.equals(this.separatelyOccupiedUnitNumber, residentialAddressCadastralAddress.separatelyOccupiedUnitNumber) &&
        Objects.equals(this.separatelyOccupiedUnitType, residentialAddressCadastralAddress.separatelyOccupiedUnitType) &&
        Objects.equals(this.cadastralNumber, residentialAddressCadastralAddress.cadastralNumber) &&
        Objects.equals(this.subNumber, residentialAddressCadastralAddress.subNumber) &&
        Objects.equals(this.addressAdditionalName, residentialAddressCadastralAddress.addressAdditionalName) &&
        Objects.equals(this.city, residentialAddressCadastralAddress.city) &&
        Objects.equals(this.coAddressName, residentialAddressCadastralAddress.coAddressName);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ResidentialAddressCadastralAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ResidentialAddressCadastralAddress.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResidentialAddressCadastralAddress is not found in the empty JSON string", ResidentialAddressCadastralAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResidentialAddressCadastralAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResidentialAddressCadastralAddress` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResidentialAddressCadastralAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResidentialAddressCadastralAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResidentialAddressCadastralAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResidentialAddressCadastralAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<ResidentialAddressCadastralAddress>() {
           @Override
           public void write(JsonWriter out, ResidentialAddressCadastralAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResidentialAddressCadastralAddress read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ResidentialAddressCadastralAddress given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ResidentialAddressCadastralAddress
  * @throws IOException if the JSON string is invalid with respect to ResidentialAddressCadastralAddress
  */
  public static ResidentialAddressCadastralAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResidentialAddressCadastralAddress.class);
  }

 /**
  * Convert an instance of ResidentialAddressCadastralAddress to an JSON string
  *
  * @return JSON string
  */
