...
/**
 * Information on a persons name.  &lt;br&gt;FREG: Folkeregisterpersonnavn
 */
@ApiModel(description = "Information on a persons name.  <br>FREG: Folkeregisterpersonnavn")
...
public class PersonName {
  ...
  private PersonNameOriginalName originalName;

  public PersonName() {
  }

  public PersonName registeredAt(OffsetDateTime registeredAt) {
  ...
  **/
  ...
  public PersonName isValid(Boolean isValid) {
  ...
  **/
  ...
  public PersonName source(String source) {
  ...
  **/
  ...
  public PersonName reason(String reason) {
  ...
  **/
  ...
  public PersonName validFrom(OffsetDateTime validFrom) {
  ...
  **/
  ...
  public PersonName validTo(OffsetDateTime validTo) {
  ...
  **/
  ...
  public PersonName shortName(String shortName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: ForkortetNavn")
  ...
  public PersonName originalName(PersonNameOriginalName originalName) {
  ...
  **/
  ...
  public PersonNameOriginalName getOriginalName() {
    return originalName;
  }


  public void setOriginalName(PersonNameOriginalName originalName) {
    this.originalName = originalName;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.registeredAt, personName.registeredAt) &&
        Objects.equals(this.isValid, personName.isValid) &&
        Objects.equals(this.source, personName.source) &&
        Objects.equals(this.reason, personName.reason) &&
        Objects.equals(this.validFrom, personName.validFrom) &&
        Objects.equals(this.validTo, personName.validTo) &&
        Objects.equals(this.givenName, personName.givenName) &&
        Objects.equals(this.middleName, personName.middleName) &&
        Objects.equals(this.familyName, personName.familyName) &&
        Objects.equals(this.shortName, personName.shortName) &&
        Objects.equals(this.originalName, personName.originalName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(registeredAt, isValid, source, reason, validFrom, validTo, givenName, middleName, familyName, shortName, originalName);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PersonName
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PersonName.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PersonName.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonName` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      // validate the optional field `originalName`
      if (jsonObj.get("originalName") != null && !jsonObj.get("originalName").isJsonNull()) {
        PersonNameOriginalName.validateJsonObject(jsonObj.getAsJsonObject("originalName"));
      }
  }
