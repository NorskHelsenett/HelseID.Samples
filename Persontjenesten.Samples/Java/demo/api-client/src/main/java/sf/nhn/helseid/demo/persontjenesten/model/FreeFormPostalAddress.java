...
public class FreeFormPostalAddress {
  ...
  * @throws IOException if the JSON Object is invalid with respect to FreeFormPostalAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (FreeFormPostalAddress.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FreeFormPostalAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FreeFormPostalAddress` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
