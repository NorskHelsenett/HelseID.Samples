 ...
 */
@ApiModel(description = "Document verification  <br>FREG: Dokumentkontroll")
...
public class DocumentVerification {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DocumentVerification
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (DocumentVerification.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DocumentVerification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DocumentVerification` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
