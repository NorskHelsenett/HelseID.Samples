        ...
        static async Task Main(string[] args)
        {
            try
            {
                ...
                var oidcClient = new OidcClient(new OidcClientOptions
                {
                    ...
                    Scope = "openid profile udelt:test-api/api helseid://scopes/identity/pid helseid://scopes/identity/security_level", // offline_access helseid://scopes/external/amk-context helseid://scopes/external/nilar-org",
                    ClientId = clientId,
