 ...
 */
@ApiModel(description = "<br>FREG: Identitetsgrunnlag")
...
public class IdentityVerification {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Category of verification for the underlying identity  <br>FREG: Identitetsgrunnlagstatus")
  ...
  * @throws IOException if the JSON Object is invalid with respect to IdentityVerification
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (IdentityVerification.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!IdentityVerification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IdentityVerification` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
