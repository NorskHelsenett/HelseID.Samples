 ...
 */
@ApiModel(description = "Search result object with a list of results.")
...
public class EventDocumentSearchResult {
  ...
  private List<EventDocument> results = null;
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventDocumentSearchResult
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (EventDocumentSearchResult.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EventDocumentSearchResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventDocumentSearchResult` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if (jsonObj.get("results") != null && !jsonObj.get("results").isJsonNull()) {
        ...
        if (jsonArrayresults != null) {
          ...
          for (int i = 0; i < jsonArrayresults.size(); i++) {
            EventDocument.validateJsonObject(jsonArrayresults.get(i).getAsJsonObject());
          };
        }
      }
  }
