...
public class GuardianOrProxyNameBirthDate {
  ...
  public GuardianOrProxyNameBirthDate() {
  }

  public GuardianOrProxyNameBirthDate name(PersonAsContactPersonName name) {
  ...
  **/
  ...
  public GuardianOrProxyNameBirthDate birthDate(OffsetDateTime birthDate) {
  ...
  **/
  ...
  public GuardianOrProxyNameBirthDate citizenship(String citizenship) {
  ...
  **/
  ...
  public GuardianOrProxyNameBirthDate gender(Gender gender) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GuardianOrProxyNameBirthDate guardianOrProxyNameBirthDate = (GuardianOrProxyNameBirthDate) o;
    return Objects.equals(this.name, guardianOrProxyNameBirthDate.name) &&
        Objects.equals(this.birthDate, guardianOrProxyNameBirthDate.birthDate) &&
        Objects.equals(this.citizenship, guardianOrProxyNameBirthDate.citizenship) &&
        Objects.equals(this.gender, guardianOrProxyNameBirthDate.gender);
  }
  ...
  public String toString() {
    ...
    sb.append("class GuardianOrProxyNameBirthDate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GuardianOrProxyNameBirthDate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (GuardianOrProxyNameBirthDate.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in GuardianOrProxyNameBirthDate is not found in the empty JSON string", GuardianOrProxyNameBirthDate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GuardianOrProxyNameBirthDate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GuardianOrProxyNameBirthDate` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GuardianOrProxyNameBirthDate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GuardianOrProxyNameBirthDate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GuardianOrProxyNameBirthDate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GuardianOrProxyNameBirthDate.class));

       return (TypeAdapter<T>) new TypeAdapter<GuardianOrProxyNameBirthDate>() {
           @Override
           public void write(JsonWriter out, GuardianOrProxyNameBirthDate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GuardianOrProxyNameBirthDate read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GuardianOrProxyNameBirthDate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GuardianOrProxyNameBirthDate
  * @throws IOException if the JSON string is invalid with respect to GuardianOrProxyNameBirthDate
  */
  public static GuardianOrProxyNameBirthDate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GuardianOrProxyNameBirthDate.class);
  }

 /**
  * Convert an instance of GuardianOrProxyNameBirthDate to an JSON string
  *
  * @return JSON string
  */
