 ...
 */
@ApiModel(description = "Used if a lawyer takes care of the estate  <br>FREG: Advokat")
...
public class ResiduaryEstateContactInformationLawyer {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ResiduaryEstateContactInformationLawyer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ResiduaryEstateContactInformationLawyer.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResiduaryEstateContactInformationLawyer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResiduaryEstateContactInformationLawyer` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
