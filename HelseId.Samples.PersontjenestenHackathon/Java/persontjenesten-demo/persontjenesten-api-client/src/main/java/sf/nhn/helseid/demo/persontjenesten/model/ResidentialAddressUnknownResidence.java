 ...
 */
@ApiModel(description = "Used if the persons residence is unknown  <br>Remarks:   May be missing, only one of the address elements are used. See ResidentialAddress  Freg: UkjentBosted")
...
public class ResidentialAddressUnknownResidence {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ResidentialAddressUnknownResidence
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ResidentialAddressUnknownResidence.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResidentialAddressUnknownResidence.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResidentialAddressUnknownResidence` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
