...
public class PresentAddressStreetAddress {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PresentAddressStreetAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PresentAddressStreetAddress.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PresentAddressStreetAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PresentAddressStreetAddress` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
