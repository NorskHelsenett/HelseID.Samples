 ...
 */
@ApiModel(description = "Street address number  A number and maybe letters that uniquely identifiers property,  facilities, buildings or entrances to building within  an addressable street, road, path, place or area  In Norway most residence has a house number and letter, but other systems exists  <br>FREG: Freg: Adressenummer")
...
public class StreetAddressNumber {
  ...
  public StreetAddressNumber() {
  }

  public StreetAddressNumber houseNumber(String houseNumber) {
  ...
  **/
  ...
  public StreetAddressNumber houseLetter(String houseLetter) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StreetAddressNumber streetAddressNumber = (StreetAddressNumber) o;
    return Objects.equals(this.houseNumber, streetAddressNumber.houseNumber) &&
        Objects.equals(this.houseLetter, streetAddressNumber.houseLetter);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreetAddressNumber {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to StreetAddressNumber
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (StreetAddressNumber.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreetAddressNumber is not found in the empty JSON string", StreetAddressNumber.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StreetAddressNumber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreetAddressNumber` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreetAddressNumber.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreetAddressNumber' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreetAddressNumber> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreetAddressNumber.class));

       return (TypeAdapter<T>) new TypeAdapter<StreetAddressNumber>() {
           @Override
           public void write(JsonWriter out, StreetAddressNumber value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreetAddressNumber read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of StreetAddressNumber given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of StreetAddressNumber
  * @throws IOException if the JSON string is invalid with respect to StreetAddressNumber
  */
  public static StreetAddressNumber fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreetAddressNumber.class);
  }

 /**
  * Convert an instance of StreetAddressNumber to an JSON string
  *
  * @return JSON string
  */
