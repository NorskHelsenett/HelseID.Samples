 ...
 */
@ApiModel(description = "<br>KRR: kontaktinformasjon              The Contact information of a person")
...
public class ContactInformationResource {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContactInformationResource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ContactInformationResource.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContactInformationResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactInformationResource` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
