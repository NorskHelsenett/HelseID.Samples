 ...
 */
@ApiModel(description = "The street address  <br>Remarks:   May be missing, only one of the address elements are used. See ResidentialAddress  Freg: Vegadresse")
...
public class ResidentialAddressStreetAddress {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ResidentialAddressStreetAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ResidentialAddressStreetAddress.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResidentialAddressStreetAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResidentialAddressStreetAddress` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
