...
public enum GuardianshipType {
  ...
  SINGLEMINORASYLUMSEEKER("SingleMinorAsylumSeeker"),
  
  SINGLEMINORREFUGEE("SingleMinorRefugee"),
  
  ADULT("Adult"),
  
  TEMPORARYFORADULT("TemporaryForAdult"),
  
  MINOR("Minor"),
  
  TEMPORARYFORMINOR("TemporaryForMinor"),
  
  MANAGEMENTOUTSIDEGUARDIANSHIP("ManagementOutsideGuardianship"),
  
  CONFIRMEDFUTUREPOWEROFATTORNEY("ConfirmedFuturePowerOfAttorney");
