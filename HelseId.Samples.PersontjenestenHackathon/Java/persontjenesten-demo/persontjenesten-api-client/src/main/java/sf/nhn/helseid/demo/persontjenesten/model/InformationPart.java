...
public enum InformationPart {
  ...
  CITIZENSHIPRETENTION("CitizenshipRetention"),
  
  RESIDENTIALADDRESS("ResidentialAddress"),
  
  USEOFSAMILANGUAGE("UseOfSamiLanguage"),
  
  SHAREDRESIDENCE("SharedResidence"),
  
  DEATH("Death"),
  
  FALSEIDENTITY("FalseIdentity"),
  
  FAMILYRELATION("FamilyRelation"),
  
  BIRTH("Birth"),
  
  BIRTHINNORWAY("BirthInNorway"),
  
  PARENTALRESPONSIBILITY("ParentalResponsibility"),
  
  SAMIPARLIAMENTELECTORALREGISTRYSTATUS("SamiParliamentElectoralRegistryStatus"),
  
  NORWEGIANIDENTIFICATIONNUMBER("NorwegianIdentificationNumber"),
  
  IDENTITYVERIFICATION("IdentityVerification"),
  
  IMMIGRATIONTONORWAY("ImmigrationToNorway"),
  
  GENDER("Gender"),
  
  RESIDUARYESTATECONTACTINFORMATION("ResiduaryEstateContactInformation"),
  ...
  STAYONSVALBARD("StayOnSvalbard"),
  
  PRESENTADDRESS("PresentAddress"),
  
  POSTALADDRESS("PostalAddress"),
  
  FOREIGNPOSTALADDRESS("ForeignPostalAddress"),
  
  PREFERREDCONTACTADDRESS("PreferredContactAddress"),
  ...
  FOREIGNPERSONIDENTIFICATIONNUMBER("ForeignPersonIdentificationNumber"),
  
  EMIGRATIONFROMNORWAY("EmigrationFromNorway"),
  
  IMMIGRATIONAUTHORITIESIDENTIFICATIONNUMBER("ImmigrationAuthoritiesIdentificationNumber"),
  
  GUARDIANSHIPORFUTUREPOWEROFATTORNEY("GuardianshipOrFuturePowerOfAttorney"),
  
  DEPRIVEDLEGALAUTHORITY("DeprivedLegalAuthority");
