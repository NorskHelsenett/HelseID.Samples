 ...
 */
@ApiModel(description = "<br>FREG: InternasjonalAdresseIFrittFormat")
...
public class FreeFormInternationalAddress {
  ...
  public FreeFormInternationalAddress() {
  }

  public FreeFormInternationalAddress addressLine(List<String> addressLine) {
    
    this.addressLine = addressLine;
    return this;
  }

  public FreeFormInternationalAddress addAddressLineItem(String addressLineItem) {
  ...
  **/
  ...
  public FreeFormInternationalAddress postCode(String postCode) {
  ...
  **/
  ...
  public FreeFormInternationalAddress cityOrPlaceName(String cityOrPlaceName) {
  ...
  **/
  ...
  public FreeFormInternationalAddress countryCode(String countryCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FreeFormInternationalAddress freeFormInternationalAddress = (FreeFormInternationalAddress) o;
    return Objects.equals(this.addressLine, freeFormInternationalAddress.addressLine) &&
        Objects.equals(this.postCode, freeFormInternationalAddress.postCode) &&
        Objects.equals(this.cityOrPlaceName, freeFormInternationalAddress.cityOrPlaceName) &&
        Objects.equals(this.countryCode, freeFormInternationalAddress.countryCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FreeFormInternationalAddress {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FreeFormInternationalAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (FreeFormInternationalAddress.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in FreeFormInternationalAddress is not found in the empty JSON string", FreeFormInternationalAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FreeFormInternationalAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FreeFormInternationalAddress` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FreeFormInternationalAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FreeFormInternationalAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FreeFormInternationalAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FreeFormInternationalAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<FreeFormInternationalAddress>() {
           @Override
           public void write(JsonWriter out, FreeFormInternationalAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FreeFormInternationalAddress read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of FreeFormInternationalAddress given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FreeFormInternationalAddress
  * @throws IOException if the JSON string is invalid with respect to FreeFormInternationalAddress
  */
  public static FreeFormInternationalAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FreeFormInternationalAddress.class);
  }

 /**
  * Convert an instance of FreeFormInternationalAddress to an JSON string
  *
  * @return JSON string
  */
