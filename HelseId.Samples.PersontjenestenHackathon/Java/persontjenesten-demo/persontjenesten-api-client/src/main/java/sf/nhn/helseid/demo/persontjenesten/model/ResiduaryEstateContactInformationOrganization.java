 ...
 */
@ApiModel(description = "Used if an organization takes care of the estate  <br>FREG: Organisasjon")
...
public class ResiduaryEstateContactInformationOrganization {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ResiduaryEstateContactInformationOrganization
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ResiduaryEstateContactInformationOrganization.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResiduaryEstateContactInformationOrganization.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResiduaryEstateContactInformationOrganization` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
