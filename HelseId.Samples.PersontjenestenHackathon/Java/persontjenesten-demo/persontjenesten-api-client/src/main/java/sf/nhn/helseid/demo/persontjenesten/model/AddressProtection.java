 ...
 */
@ApiModel(description = "This information is used to describe the overall protection level a person have on all his addresses of types  residential, living and shared residence addresses. The address protection does not apply to  contact addresses.  <br>FREG: GraderingAvAdresse")
...
public class AddressProtection {
  ...
  private AddressConfidentiality protectionLevel;

  public AddressProtection() {
  }

  public AddressProtection registeredAt(OffsetDateTime registeredAt) {
  ...
  **/
  ...
  public AddressProtection isValid(Boolean isValid) {
  ...
  **/
  ...
  public AddressProtection source(String source) {
  ...
  **/
  ...
  public AddressProtection reason(String reason) {
  ...
  **/
  ...
  public AddressProtection validFrom(OffsetDateTime validFrom) {
  ...
  **/
  ...
  public AddressProtection validTo(OffsetDateTime validTo) {
  ...
  **/
  ...
  public AddressProtection protectionLevel(AddressConfidentiality protectionLevel) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Overall protection level on addresses.  Legal values are:  AddressConfidentiality.UnclassifiedAddressConfidentiality.ConfidentialAddressConfidentiality.StrictlyConfidential<br>FREG: Graderingsnivaa")

  public AddressConfidentiality getProtectionLevel() {
    return protectionLevel;
  }


  public void setProtectionLevel(AddressConfidentiality protectionLevel) {
    this.protectionLevel = protectionLevel;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddressProtection addressProtection = (AddressProtection) o;
    return Objects.equals(this.registeredAt, addressProtection.registeredAt) &&
        Objects.equals(this.isValid, addressProtection.isValid) &&
        Objects.equals(this.source, addressProtection.source) &&
        Objects.equals(this.reason, addressProtection.reason) &&
        Objects.equals(this.validFrom, addressProtection.validFrom) &&
        Objects.equals(this.validTo, addressProtection.validTo) &&
        Objects.equals(this.protectionLevel, addressProtection.protectionLevel);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(registeredAt, isValid, source, reason, validFrom, validTo, protectionLevel);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddressProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (AddressProtection.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddressProtection is not found in the empty JSON string", AddressProtection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AddressProtection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddressProtection` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddressProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddressProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddressProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddressProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<AddressProtection>() {
           @Override
           public void write(JsonWriter out, AddressProtection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddressProtection read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AddressProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddressProtection
  * @throws IOException if the JSON string is invalid with respect to AddressProtection
  */
  public static AddressProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddressProtection.class);
  }

 /**
  * Convert an instance of AddressProtection to an JSON string
  *
  * @return JSON string
  */
