 ...
 */
@ApiModel(description = "<br>FREG: Folkeregisterpersonstatus")
...
public class PersonStatus {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PersonStatus
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PersonStatus.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PersonStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonStatus` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
