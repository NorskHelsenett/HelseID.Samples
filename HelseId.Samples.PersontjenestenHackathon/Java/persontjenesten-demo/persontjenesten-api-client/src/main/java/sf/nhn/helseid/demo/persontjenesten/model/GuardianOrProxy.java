 ...
 */
@ApiModel(description = "<br>FREG: VergeRepresentantEllerFullmektig")
...
public class GuardianOrProxy {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GuardianOrProxy
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (GuardianOrProxy.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GuardianOrProxy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GuardianOrProxy` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
