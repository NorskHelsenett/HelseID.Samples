...
public class PersonCommonContactRegisterInformation {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PersonCommonContactRegisterInformation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PersonCommonContactRegisterInformation.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PersonCommonContactRegisterInformation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonCommonContactRegisterInformation` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
