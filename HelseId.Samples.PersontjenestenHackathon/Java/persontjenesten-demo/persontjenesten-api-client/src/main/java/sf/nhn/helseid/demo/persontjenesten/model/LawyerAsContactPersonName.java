 ...
 */
@ApiModel(description = "Contact person  <br>FREG: Personnavn")
...
public class LawyerAsContactPersonName {
  ...
  public LawyerAsContactPersonName() {
  }

  public LawyerAsContactPersonName givenName(String givenName) {
  ...
  **/
  ...
  public LawyerAsContactPersonName middleName(String middleName) {
  ...
  **/
  ...
  public LawyerAsContactPersonName familyName(String familyName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LawyerAsContactPersonName lawyerAsContactPersonName = (LawyerAsContactPersonName) o;
    return Objects.equals(this.givenName, lawyerAsContactPersonName.givenName) &&
        Objects.equals(this.middleName, lawyerAsContactPersonName.middleName) &&
        Objects.equals(this.familyName, lawyerAsContactPersonName.familyName);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LawyerAsContactPersonName
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (LawyerAsContactPersonName.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in LawyerAsContactPersonName is not found in the empty JSON string", LawyerAsContactPersonName.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!LawyerAsContactPersonName.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LawyerAsContactPersonName` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LawyerAsContactPersonName.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LawyerAsContactPersonName' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LawyerAsContactPersonName> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LawyerAsContactPersonName.class));

       return (TypeAdapter<T>) new TypeAdapter<LawyerAsContactPersonName>() {
           @Override
           public void write(JsonWriter out, LawyerAsContactPersonName value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LawyerAsContactPersonName read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LawyerAsContactPersonName given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LawyerAsContactPersonName
  * @throws IOException if the JSON string is invalid with respect to LawyerAsContactPersonName
  */
  public static LawyerAsContactPersonName fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LawyerAsContactPersonName.class);
  }

 /**
  * Convert an instance of LawyerAsContactPersonName to an JSON string
  *
  * @return JSON string
  */
