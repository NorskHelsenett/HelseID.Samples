 ...
 */
@ApiModel(description = "The cadastral address for the shared residence  <br>Remarks:   May be missing, only one of the address elements are used. See ResidentialAddress  Freg: Matrikkeladresse")
...
public class SharedResidenceCadastralAddress {
  ...
  public SharedResidenceCadastralAddress() {
  }

  public SharedResidenceCadastralAddress separatelyOccupiedUnitNumber(String separatelyOccupiedUnitNumber) {
  ...
  **/
  ...
  public SharedResidenceCadastralAddress separatelyOccupiedUnitType(SeparatelyOccupiedUnitType separatelyOccupiedUnitType) {
  ...
  **/
  ...
  public SharedResidenceCadastralAddress cadastralNumber(CadastralAddressCadastralNumber cadastralNumber) {
  ...
  **/
  ...
  public SharedResidenceCadastralAddress subNumber(Long subNumber) {
  ...
  **/
  ...
  public SharedResidenceCadastralAddress addressAdditionalName(String addressAdditionalName) {
  ...
  **/
  ...
  public SharedResidenceCadastralAddress city(CadastralAddressCity city) {
  ...
  **/
  ...
  public SharedResidenceCadastralAddress coAddressName(String coAddressName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SharedResidenceCadastralAddress sharedResidenceCadastralAddress = (SharedResidenceCadastralAddress) o;
    return Objects.equals(this.separatelyOccupiedUnitNumber, sharedResidenceCadastralAddress.separatelyOccupiedUnitNumber) &&
        Objects.equals(this.separatelyOccupiedUnitType, sharedResidenceCadastralAddress.separatelyOccupiedUnitType) &&
        Objects.equals(this.cadastralNumber, sharedResidenceCadastralAddress.cadastralNumber) &&
        Objects.equals(this.subNumber, sharedResidenceCadastralAddress.subNumber) &&
        Objects.equals(this.addressAdditionalName, sharedResidenceCadastralAddress.addressAdditionalName) &&
        Objects.equals(this.city, sharedResidenceCadastralAddress.city) &&
        Objects.equals(this.coAddressName, sharedResidenceCadastralAddress.coAddressName);
  }
  ...
  public String toString() {
    ...
    sb.append("class SharedResidenceCadastralAddress {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SharedResidenceCadastralAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SharedResidenceCadastralAddress.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in SharedResidenceCadastralAddress is not found in the empty JSON string", SharedResidenceCadastralAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SharedResidenceCadastralAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SharedResidenceCadastralAddress` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SharedResidenceCadastralAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SharedResidenceCadastralAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SharedResidenceCadastralAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SharedResidenceCadastralAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<SharedResidenceCadastralAddress>() {
           @Override
           public void write(JsonWriter out, SharedResidenceCadastralAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SharedResidenceCadastralAddress read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SharedResidenceCadastralAddress given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SharedResidenceCadastralAddress
  * @throws IOException if the JSON string is invalid with respect to SharedResidenceCadastralAddress
  */
  public static SharedResidenceCadastralAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SharedResidenceCadastralAddress.class);
  }

 /**
  * Convert an instance of SharedResidenceCadastralAddress to an JSON string
  *
  * @return JSON string
  */
