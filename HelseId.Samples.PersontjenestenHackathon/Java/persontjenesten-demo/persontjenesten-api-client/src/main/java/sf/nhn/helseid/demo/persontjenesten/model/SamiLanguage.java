...
/**
 * Information on which sami languages a person uses.  &lt;br&gt;FREG: SamiskSpraak
 */
@ApiModel(description = "Information on which sami languages a person uses.  <br>FREG: SamiskSpraak")
...
public class SamiLanguage {
  ...
  private List<SamiLanguageType> language = null;

  public SamiLanguage() {
  }

  public SamiLanguage registeredAt(OffsetDateTime registeredAt) {
  ...
  **/
  ...
  public SamiLanguage isValid(Boolean isValid) {
  ...
  **/
  ...
  public SamiLanguage source(String source) {
  ...
  **/
  ...
  public SamiLanguage reason(String reason) {
  ...
  **/
  ...
  public SamiLanguage validFrom(OffsetDateTime validFrom) {
  ...
  **/
  ...
  public SamiLanguage validTo(OffsetDateTime validTo) {
  ...
  **/
  ...
  public SamiLanguage language(List<SamiLanguageType> language) {
    
    this.language = language;
    return this;
  }

  public SamiLanguage addLanguageItem(SamiLanguageType languageItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Spraak")

  public List<SamiLanguageType> getLanguage() {
    return language;
  }


  public void setLanguage(List<SamiLanguageType> language) {
    this.language = language;
  }
  ...
  public boolean equals(Object o) {
    ...
    SamiLanguage samiLanguage = (SamiLanguage) o;
    return Objects.equals(this.registeredAt, samiLanguage.registeredAt) &&
        Objects.equals(this.isValid, samiLanguage.isValid) &&
        Objects.equals(this.source, samiLanguage.source) &&
        Objects.equals(this.reason, samiLanguage.reason) &&
        Objects.equals(this.validFrom, samiLanguage.validFrom) &&
        Objects.equals(this.validTo, samiLanguage.validTo) &&
        Objects.equals(this.language, samiLanguage.language);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(registeredAt, isValid, source, reason, validFrom, validTo, language);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SamiLanguage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SamiLanguage.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in SamiLanguage is not found in the empty JSON string", SamiLanguage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SamiLanguage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SamiLanguage` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SamiLanguage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SamiLanguage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SamiLanguage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SamiLanguage.class));

       return (TypeAdapter<T>) new TypeAdapter<SamiLanguage>() {
           @Override
           public void write(JsonWriter out, SamiLanguage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SamiLanguage read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SamiLanguage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SamiLanguage
  * @throws IOException if the JSON string is invalid with respect to SamiLanguage
  */
  public static SamiLanguage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SamiLanguage.class);
  }

 /**
  * Convert an instance of SamiLanguage to an JSON string
  *
  * @return JSON string
  */
