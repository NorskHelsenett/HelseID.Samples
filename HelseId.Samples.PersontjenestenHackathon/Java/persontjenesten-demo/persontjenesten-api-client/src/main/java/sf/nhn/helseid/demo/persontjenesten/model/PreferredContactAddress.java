 ...
 */
@ApiModel(description = "Will be removed with deprecation of API v1.0  <br>FREG: PreferertKontaktadresse")
...
public class PreferredContactAddress {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Valg")
  ...
  * @throws IOException if the JSON Object is invalid with respect to PreferredContactAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PreferredContactAddress.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PreferredContactAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PreferredContactAddress` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("freeformContactAddress") != null && !jsonObj.get("freeformContactAddress").isJsonNull()) {
        PreferredContactAddressFreeformContactAddress.validateJsonObject(jsonObj.getAsJsonObject("freeformContactAddress"));
      }
  }
