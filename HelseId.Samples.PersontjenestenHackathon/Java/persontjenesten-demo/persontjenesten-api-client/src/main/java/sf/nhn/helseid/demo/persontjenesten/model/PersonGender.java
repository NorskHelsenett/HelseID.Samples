 ...
 */
@ApiModel(description = "<br>FREG: Personkjoenn")
...
public class PersonGender {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PersonGender
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PersonGender.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PersonGender.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonGender` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
