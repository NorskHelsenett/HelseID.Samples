 ...
 */
@ApiModel(description = "Information on the country and city of residence of the person before immigration to norway.  Country codes are given in ISO 3166-1 alfa 3  <br>FREG: InnflyttingTilNorge")
...
public class ImmigrationToNorway {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: FraflyttingsstedIUtland")
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImmigrationToNorway
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ImmigrationToNorway.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ImmigrationToNorway.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImmigrationToNorway` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
