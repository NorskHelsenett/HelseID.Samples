 ...
 */
@ApiModel(description = "Information on a person in the Person API.  Data is primarily from the National Population Register (FREG), but also contains data from other sources.")
...
public class Person {
  ...
  private List<NorwegianIdentificationNumber> norwegianIdentificationNumber = null;
  ...
  private List<IdentityVerification> identityVerification = null;
  ...
  private List<ResiduaryEstateContactInformation> residuaryEstateContactInformation = null;
  ...
  private List<IdentificationDocument> identificationDocument = null;

  public static final String SERIALIZED_NAME_STATUS = "status";
  @SerializedName(SERIALIZED_NAME_STATUS)
  private List<PersonStatus> status = null;
  ...
  private List<PersonIdentification> immigrationAuthoritiesIdentificationNumber = null;
  ...
  private List<PersonIdentification> foreignPersonIdentificationNumber = null;
  ...
  private List<PersonName> name = null;
  ...
  private List<AddressProtection> addressProtection = null;
  ...
  private List<PresentAddress> presentAddress = null;
  ...
  private List<ImmigrationToNorway> immigrationToNorway = null;
  ...
  private List<EmigrationFromNorway> emigrationFromNorway = null;
  ...
  private List<SamiLanguage> useOfSamiLanguage = null;
  ...
  private List<SamiParliamentElectoralRegistry> samiParliamentElectoralRegistryStatus = null;
  ...
  private List<ForeignContactAddress> foreignPostalAddress = null;
  ...
  private List<ParentalResponsibility> parentalResponsibility = null;
  ...
  private List<NorwegianCitizenshipRetention> citizenshipRetention = null;
  ...
  private List<ResidencePermit> residencePermit = null;
  ...
  private List<StayOnSvalbard> stayOnSvalbard = null;
  ...
  private List<GuardianshipOrFuturePowerOfAttorney> guardianshipOrFuturePowerOfAttorney = null;
  ...
  private List<DeprivedLegalAuthority> deprivedLegalAuthority = null;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Identifikasjonsnummer")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If empty, is the same as IdentityVerificationStatus.None<br>FREG: Identitetsgrunnlag")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: KontaktinformasjonForDoedsbo")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Legitimasjonsdokument")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: UtlendingsmyndighetenesIdentifikasjonsnummer")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: UtenlandskPersonidentifikasjon")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List may only contain 0 or 1 element  <br>FREG: DeltBosted")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Foedsel")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: FoedselINorge")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Familierelasjon")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Sivilstand")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Navn")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Adressebeskyttelse")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Bostedsadresse")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Oppholdsadresse")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Innflytting")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Utflytting")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: BrukAvSamiskSpraak")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: ForholdTilSametingetsValgmanntall")
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Will be removed with deprecation of API v1.0  <br>FREG: PreferertKontaktadresse")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Postadresse")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: PostadresseIUtlandet")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Foreldreansvar")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Bibehold")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: Opphold")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: OppholdPaaSvalbard")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: VergemaalEllerFremtidsfullmakt")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<br>FREG: FratattRettsligHandleevne ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A person's id. A unique identifier created by the Person API.")
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("falseIdentity") != null && !jsonObj.get("falseIdentity").isJsonNull()) {
        PersonFalseIdentity.validateJsonObject(jsonObj.getAsJsonObject("falseIdentity"));
      }
      if (jsonObj.get("norwegianIdentificationNumber") != null && !jsonObj.get("norwegianIdentificationNumber").isJsonNull()) {
        ...
        if (jsonArraynorwegianIdentificationNumber != null) {
          ...
          for (int i = 0; i < jsonArraynorwegianIdentificationNumber.size(); i++) {
            NorwegianIdentificationNumber.validateJsonObject(jsonArraynorwegianIdentificationNumber.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("identityVerification") != null && !jsonObj.get("identityVerification").isJsonNull()) {
        ...
        if (jsonArrayidentityVerification != null) {
          ...
          for (int i = 0; i < jsonArrayidentityVerification.size(); i++) {
            IdentityVerification.validateJsonObject(jsonArrayidentityVerification.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("residuaryEstateContactInformation") != null && !jsonObj.get("residuaryEstateContactInformation").isJsonNull()) {
        ...
        if (jsonArrayresiduaryEstateContactInformation != null) {
          ...
          for (int i = 0; i < jsonArrayresiduaryEstateContactInformation.size(); i++) {
            ResiduaryEstateContactInformation.validateJsonObject(jsonArrayresiduaryEstateContactInformation.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("identificationDocument") != null && !jsonObj.get("identificationDocument").isJsonNull()) {
        ...
        if (jsonArrayidentificationDocument != null) {
          ...
          for (int i = 0; i < jsonArrayidentificationDocument.size(); i++) {
            IdentificationDocument.validateJsonObject(jsonArrayidentificationDocument.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("status") != null && !jsonObj.get("status").isJsonNull()) {
        ...
        if (jsonArraystatus != null) {
          ...
          for (int i = 0; i < jsonArraystatus.size(); i++) {
            PersonStatus.validateJsonObject(jsonArraystatus.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("immigrationAuthoritiesIdentificationNumber") != null && !jsonObj.get("immigrationAuthoritiesIdentificationNumber").isJsonNull()) {
        ...
        if (jsonArrayimmigrationAuthoritiesIdentificationNumber != null) {
          ...
          for (int i = 0; i < jsonArrayimmigrationAuthoritiesIdentificationNumber.size(); i++) {
            PersonIdentification.validateJsonObject(jsonArrayimmigrationAuthoritiesIdentificationNumber.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("foreignPersonIdentificationNumber") != null && !jsonObj.get("foreignPersonIdentificationNumber").isJsonNull()) {
        ...
        if (jsonArrayforeignPersonIdentificationNumber != null) {
          ...
          for (int i = 0; i < jsonArrayforeignPersonIdentificationNumber.size(); i++) {
            PersonIdentification.validateJsonObject(jsonArrayforeignPersonIdentificationNumber.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("sharedResidence") != null && !jsonObj.get("sharedResidence").isJsonNull()) {
        ...
        if (jsonArraysharedResidence != null) {
          ...
          for (int i = 0; i < jsonArraysharedResidence.size(); i++) {
            SharedResidence.validateJsonObject(jsonArraysharedResidence.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("gender") != null && !jsonObj.get("gender").isJsonNull()) {
        ...
        if (jsonArraygender != null) {
          ...
          for (int i = 0; i < jsonArraygender.size(); i++) {
            PersonGender.validateJsonObject(jsonArraygender.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("birth") != null && !jsonObj.get("birth").isJsonNull()) {
        ...
        if (jsonArraybirth != null) {
          ...
          for (int i = 0; i < jsonArraybirth.size(); i++) {
            Birth.validateJsonObject(jsonArraybirth.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("birthInNorway") != null && !jsonObj.get("birthInNorway").isJsonNull()) {
        ...
        if (jsonArraybirthInNorway != null) {
          ...
          for (int i = 0; i < jsonArraybirthInNorway.size(); i++) {
            BirthInNorway.validateJsonObject(jsonArraybirthInNorway.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("familyRelation") != null && !jsonObj.get("familyRelation").isJsonNull()) {
        ...
        if (jsonArrayfamilyRelation != null) {
          ...
          for (int i = 0; i < jsonArrayfamilyRelation.size(); i++) {
            FamilyRelation.validateJsonObject(jsonArrayfamilyRelation.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("maritalStatus") != null && !jsonObj.get("maritalStatus").isJsonNull()) {
        ...
        if (jsonArraymaritalStatus != null) {
          ...
          for (int i = 0; i < jsonArraymaritalStatus.size(); i++) {
            MaritalStatus.validateJsonObject(jsonArraymaritalStatus.get(i).getAsJsonObject());
          };
        }
      }
      // validate the optional field `death`
      if (jsonObj.get("death") != null && !jsonObj.get("death").isJsonNull()) {
        PersonDeath.validateJsonObject(jsonObj.getAsJsonObject("death"));
      }
      if (jsonObj.get("name") != null && !jsonObj.get("name").isJsonNull()) {
        ...
        if (jsonArrayname != null) {
          ...
          for (int i = 0; i < jsonArrayname.size(); i++) {
            PersonName.validateJsonObject(jsonArrayname.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("addressProtection") != null && !jsonObj.get("addressProtection").isJsonNull()) {
        ...
        if (jsonArrayaddressProtection != null) {
          ...
          for (int i = 0; i < jsonArrayaddressProtection.size(); i++) {
            AddressProtection.validateJsonObject(jsonArrayaddressProtection.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("residentialAddress") != null && !jsonObj.get("residentialAddress").isJsonNull()) {
        ...
        if (jsonArrayresidentialAddress != null) {
          ...
          for (int i = 0; i < jsonArrayresidentialAddress.size(); i++) {
            ResidentialAddress.validateJsonObject(jsonArrayresidentialAddress.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("presentAddress") != null && !jsonObj.get("presentAddress").isJsonNull()) {
        ...
        if (jsonArraypresentAddress != null) {
          ...
          for (int i = 0; i < jsonArraypresentAddress.size(); i++) {
            PresentAddress.validateJsonObject(jsonArraypresentAddress.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("immigrationToNorway") != null && !jsonObj.get("immigrationToNorway").isJsonNull()) {
        ...
        if (jsonArrayimmigrationToNorway != null) {
          ...
          for (int i = 0; i < jsonArrayimmigrationToNorway.size(); i++) {
            ImmigrationToNorway.validateJsonObject(jsonArrayimmigrationToNorway.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("emigrationFromNorway") != null && !jsonObj.get("emigrationFromNorway").isJsonNull()) {
        ...
        if (jsonArrayemigrationFromNorway != null) {
          ...
          for (int i = 0; i < jsonArrayemigrationFromNorway.size(); i++) {
            EmigrationFromNorway.validateJsonObject(jsonArrayemigrationFromNorway.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("useOfSamiLanguage") != null && !jsonObj.get("useOfSamiLanguage").isJsonNull()) {
        ...
        if (jsonArrayuseOfSamiLanguage != null) {
          ...
          for (int i = 0; i < jsonArrayuseOfSamiLanguage.size(); i++) {
            SamiLanguage.validateJsonObject(jsonArrayuseOfSamiLanguage.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("samiParliamentElectoralRegistryStatus") != null && !jsonObj.get("samiParliamentElectoralRegistryStatus").isJsonNull()) {
        ...
        if (jsonArraysamiParliamentElectoralRegistryStatus != null) {
          ...
          for (int i = 0; i < jsonArraysamiParliamentElectoralRegistryStatus.size(); i++) {
            SamiParliamentElectoralRegistry.validateJsonObject(jsonArraysamiParliamentElectoralRegistryStatus.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("preferredContactAddress") != null && !jsonObj.get("preferredContactAddress").isJsonNull()) {
        ...
        if (jsonArraypreferredContactAddress != null) {
          ...
          for (int i = 0; i < jsonArraypreferredContactAddress.size(); i++) {
            PreferredContactAddress.validateJsonObject(jsonArraypreferredContactAddress.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("postalAddress") != null && !jsonObj.get("postalAddress").isJsonNull()) {
        ...
        if (jsonArraypostalAddress != null) {
          ...
          for (int i = 0; i < jsonArraypostalAddress.size(); i++) {
            ContactAddress.validateJsonObject(jsonArraypostalAddress.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("foreignPostalAddress") != null && !jsonObj.get("foreignPostalAddress").isJsonNull()) {
        ...
        if (jsonArrayforeignPostalAddress != null) {
          ...
          for (int i = 0; i < jsonArrayforeignPostalAddress.size(); i++) {
            ForeignContactAddress.validateJsonObject(jsonArrayforeignPostalAddress.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("parentalResponsibility") != null && !jsonObj.get("parentalResponsibility").isJsonNull()) {
        ...
        if (jsonArrayparentalResponsibility != null) {
          ...
          for (int i = 0; i < jsonArrayparentalResponsibility.size(); i++) {
            ParentalResponsibility.validateJsonObject(jsonArrayparentalResponsibility.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("citizenship") != null && !jsonObj.get("citizenship").isJsonNull()) {
        ...
        if (jsonArraycitizenship != null) {
          ...
          for (int i = 0; i < jsonArraycitizenship.size(); i++) {
            Citizenship.validateJsonObject(jsonArraycitizenship.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("citizenshipRetention") != null && !jsonObj.get("citizenshipRetention").isJsonNull()) {
        ...
        if (jsonArraycitizenshipRetention != null) {
          ...
          for (int i = 0; i < jsonArraycitizenshipRetention.size(); i++) {
            NorwegianCitizenshipRetention.validateJsonObject(jsonArraycitizenshipRetention.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("residencePermit") != null && !jsonObj.get("residencePermit").isJsonNull()) {
        ...
        if (jsonArrayresidencePermit != null) {
          ...
          for (int i = 0; i < jsonArrayresidencePermit.size(); i++) {
            ResidencePermit.validateJsonObject(jsonArrayresidencePermit.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("stayOnSvalbard") != null && !jsonObj.get("stayOnSvalbard").isJsonNull()) {
        ...
        if (jsonArraystayOnSvalbard != null) {
          ...
          for (int i = 0; i < jsonArraystayOnSvalbard.size(); i++) {
            StayOnSvalbard.validateJsonObject(jsonArraystayOnSvalbard.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("guardianshipOrFuturePowerOfAttorney") != null && !jsonObj.get("guardianshipOrFuturePowerOfAttorney").isJsonNull()) {
        ...
        if (jsonArrayguardianshipOrFuturePowerOfAttorney != null) {
          ...
          for (int i = 0; i < jsonArrayguardianshipOrFuturePowerOfAttorney.size(); i++) {
            GuardianshipOrFuturePowerOfAttorney.validateJsonObject(jsonArrayguardianshipOrFuturePowerOfAttorney.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("deprivedLegalAuthority") != null && !jsonObj.get("deprivedLegalAuthority").isJsonNull()) {
        ...
        if (jsonArraydeprivedLegalAuthority != null) {
          ...
          for (int i = 0; i < jsonArraydeprivedLegalAuthority.size(); i++) {
            DeprivedLegalAuthority.validateJsonObject(jsonArraydeprivedLegalAuthority.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("commonContactRegisterInformation") != null && !jsonObj.get("commonContactRegisterInformation").isJsonNull()) {
        PersonCommonContactRegisterInformation.validateJsonObject(jsonObj.getAsJsonObject("commonContactRegisterInformation"));
      }
  }
