 ...
 * &lt;br&gt;KRR: digital_post
 */
@ApiModel(description = "<br>KRR: digital_post")
...
public class DigitalPostResource {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DigitalPostResource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (DigitalPostResource.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DigitalPostResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DigitalPostResource` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
