...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonSearchResult")]
    public partial class PersonSearchResult : IEquatable<PersonSearchResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonSearchResult" /> class.
        /// </summary>
        /// <param name="results">results.</param>
        public PersonSearchResult(List<Person> results = default(List<Person>))
        {
        ...
        {
            return this.Equals(input as PersonSearchResult);
        }

        /// <summary>
        /// Returns true if PersonSearchResult instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonSearchResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonSearchResult input)
        {
            if (input == null)
            {
                return false;
