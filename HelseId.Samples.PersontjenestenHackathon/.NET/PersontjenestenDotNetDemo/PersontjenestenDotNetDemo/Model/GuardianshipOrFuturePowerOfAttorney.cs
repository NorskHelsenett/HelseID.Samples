...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GuardianshipOrFuturePowerOfAttorney")]
    public partial class GuardianshipOrFuturePowerOfAttorney : IEquatable<GuardianshipOrFuturePowerOfAttorney>, IValidatableObject
    {
        ...
        [DataMember(Name = "guardianshipType", EmitDefaultValue = true)]
        public GuardianshipType? GuardianshipType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="GuardianshipOrFuturePowerOfAttorney" /> class.
        /// </summary>
        ...
        /// <param name="guardianshipType">&lt;br&gt;FREG: Vergemaaltype.</param>
        /// <param name="office">&lt;br&gt;FREG: Embete.</param>
        /// <param name="guardian">guardian.</param>
        public GuardianshipOrFuturePowerOfAttorney(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), GuardianshipType? guardianshipType = default(GuardianshipType?), string office = default(string), GuardianshipOrFuturePowerOfAttorneyGuardian guardian = default(GuardianshipOrFuturePowerOfAttorneyGuardian))
        {
        ...
        /// </summary>
        [DataMember(Name = "guardian", EmitDefaultValue = true)]
        public GuardianshipOrFuturePowerOfAttorneyGuardian Guardian { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  GuardianshipType: ").Append(GuardianshipType).Append("\n");
        ...
        {
            return this.Equals(input as GuardianshipOrFuturePowerOfAttorney);
        }

        /// <summary>
        /// Returns true if GuardianshipOrFuturePowerOfAttorney instances are equal
        /// </summary>
        /// <param name="input">Instance of GuardianshipOrFuturePowerOfAttorney to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GuardianshipOrFuturePowerOfAttorney input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GuardianshipType == input.GuardianshipType ||
                    this.GuardianshipType.Equals(input.GuardianshipType)
                ) && 
                (
                ...
                (
                    this.Guardian == input.Guardian ||
                    (this.Guardian != null &&
                    this.Guardian.Equals(input.Guardian))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.GuardianshipType.GetHashCode();
                if (this.Office != null)
                {
                ...
                {
                    hashCode = (hashCode * 59) + this.Guardian.GetHashCode();
                }
                return hashCode;
            }
        }
