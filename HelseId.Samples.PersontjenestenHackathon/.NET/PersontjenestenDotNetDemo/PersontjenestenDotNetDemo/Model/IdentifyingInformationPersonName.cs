...
namespace Org.OpenAPITools.Model
{
    ...
    /// &lt;br&gt;FREG: Personnavn
    /// </summary>
    [DataContract(Name = "IdentifyingInformation_personName")]
    public partial class IdentifyingInformationPersonName : IEquatable<IdentifyingInformationPersonName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentifyingInformationPersonName" /> class.
        /// </summary>
        ...
        public IdentifyingInformationPersonName(string givenName = default(string), string middleName = default(string), string familyName = default(string))
        {
        ...
        {
            return this.Equals(input as IdentifyingInformationPersonName);
        }

        /// <summary>
        /// Returns true if IdentifyingInformationPersonName instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentifyingInformationPersonName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentifyingInformationPersonName input)
        {
            if (input == null)
            {
                return false;
