...
namespace Org.OpenAPITools.Model
{
    ...
    /// &lt;br&gt;FREG: Vegadresse
    /// </summary>
    [DataContract(Name = "ContactAddress_streetAddress")]
    public partial class ContactAddressStreetAddress : IEquatable<ContactAddressStreetAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactAddressStreetAddress" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ContactAddressStreetAddress);
        }

        /// <summary>
        /// Returns true if ContactAddressStreetAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactAddressStreetAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactAddressStreetAddress input)
        {
            if (input == null)
            {
                return false;
