...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PresentAddress_cadastralAddress")]
    public partial class PresentAddressCadastralAddress : IEquatable<PresentAddressCadastralAddress>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PresentAddressCadastralAddress" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PresentAddressCadastralAddress);
        }

        /// <summary>
        /// Returns true if PresentAddressCadastralAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of PresentAddressCadastralAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PresentAddressCadastralAddress input)
        {
            if (input == null)
            {
                return false;
