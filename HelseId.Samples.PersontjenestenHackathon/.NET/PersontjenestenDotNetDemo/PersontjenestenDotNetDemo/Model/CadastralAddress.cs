...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CadastralAddress")]
    public partial class CadastralAddress : IEquatable<CadastralAddress>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CadastralAddress" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CadastralAddress);
        }

        /// <summary>
        /// Returns true if CadastralAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of CadastralAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CadastralAddress input)
        {
            if (input == null)
            {
                return false;
