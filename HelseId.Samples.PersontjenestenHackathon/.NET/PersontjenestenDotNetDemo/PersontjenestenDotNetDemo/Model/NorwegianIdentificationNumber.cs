...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NorwegianIdentificationNumber")]
    public partial class NorwegianIdentificationNumber : IEquatable<NorwegianIdentificationNumber>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>&lt;br&gt;FREG: Identifikatortype</value>
        [DataMember(Name = "identificationNumberType", EmitDefaultValue = false)]
        public NorwegianIdentificationNumberType? IdentificationNumberType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="NorwegianIdentificationNumber" /> class.
        /// </summary>
        ...
        /// <param name="identificationNumber">National identity number (fødselsnummer) or D-number (d-nummer)  &lt;br&gt;FREG: FoedselsEllerDNummer.</param>
        /// <param name="identificationNumberType">&lt;br&gt;FREG: Identifikatortype.</param>
        public NorwegianIdentificationNumber(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), IdentificationStatus? status = default(IdentificationStatus?), string identificationNumber = default(string), NorwegianIdentificationNumberType? identificationNumberType = default(NorwegianIdentificationNumberType?))
        {
        ...
        /// </summary>
        /// <value>National identity number (fødselsnummer) or D-number (d-nummer)  &lt;br&gt;FREG: FoedselsEllerDNummer</value>
        ...
        {
            return this.Equals(input as NorwegianIdentificationNumber);
        }

        /// <summary>
        /// Returns true if NorwegianIdentificationNumber instances are equal
        /// </summary>
        /// <param name="input">Instance of NorwegianIdentificationNumber to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NorwegianIdentificationNumber input)
        {
            if (input == null)
            {
                return false;
