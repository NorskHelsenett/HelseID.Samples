...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CadastralNumber")]
    public partial class CadastralNumber : IEquatable<CadastralNumber>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CadastralNumber" /> class.
        /// </summary>
        ...
        public CadastralNumber(string municipalityNumber = default(string), long? municipalityLandNumber = default(long?), long? titleNumber = default(long?), long? leaseholdNumber = default(long?))
        {
        ...
        {
            return this.Equals(input as CadastralNumber);
        }

        /// <summary>
        /// Returns true if CadastralNumber instances are equal
        /// </summary>
        /// <param name="input">Instance of CadastralNumber to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CadastralNumber input)
        {
            if (input == null)
            {
                return false;
