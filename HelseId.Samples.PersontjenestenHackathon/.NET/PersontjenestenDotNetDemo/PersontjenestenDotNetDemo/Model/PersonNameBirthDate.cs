...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonNameBirthDate")]
    public partial class PersonNameBirthDate : IEquatable<PersonNameBirthDate>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonNameBirthDate" /> class.
        /// </summary>
        ...
        public PersonNameBirthDate(PersonAsContactPersonName name = default(PersonAsContactPersonName), DateTime? birthDate = default(DateTime?), string citizenship = default(string), Gender? gender = default(Gender?))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as PersonNameBirthDate);
        }

        /// <summary>
        /// Returns true if PersonNameBirthDate instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonNameBirthDate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonNameBirthDate input)
        {
            if (input == null)
            {
                return false;
