...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResiduaryEstateContactInformation_person")]
    public partial class ResiduaryEstateContactInformationPerson : IEquatable<ResiduaryEstateContactInformationPerson>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResiduaryEstateContactInformationPerson" /> class.
        /// </summary>
        ...
        public ResiduaryEstateContactInformationPerson(DateTime? birthDate = default(DateTime?), PersonAsContactPersonName personName = default(PersonAsContactPersonName), string norwegianIdentificationNumber = default(string))
        {
        ...
        {
            return this.Equals(input as ResiduaryEstateContactInformationPerson);
        }

        /// <summary>
        /// Returns true if ResiduaryEstateContactInformationPerson instances are equal
        /// </summary>
        /// <param name="input">Instance of ResiduaryEstateContactInformationPerson to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResiduaryEstateContactInformationPerson input)
        {
            if (input == null)
            {
                return false;
