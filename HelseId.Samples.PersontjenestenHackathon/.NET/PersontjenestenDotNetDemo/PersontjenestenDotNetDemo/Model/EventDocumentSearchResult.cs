...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EventDocumentSearchResult")]
    public partial class EventDocumentSearchResult : IEquatable<EventDocumentSearchResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventDocumentSearchResult" /> class.
        /// </summary>
        /// <param name="results">results.</param>
        public EventDocumentSearchResult(List<EventDocument> results = default(List<EventDocument>))
        {
        ...
        public List<EventDocument> Results { get; set; }
        ...
        {
            return this.Equals(input as EventDocumentSearchResult);
        }

        /// <summary>
        /// Returns true if EventDocumentSearchResult instances are equal
        /// </summary>
        /// <param name="input">Instance of EventDocumentSearchResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventDocumentSearchResult input)
        {
            if (input == null)
            {
                return false;
