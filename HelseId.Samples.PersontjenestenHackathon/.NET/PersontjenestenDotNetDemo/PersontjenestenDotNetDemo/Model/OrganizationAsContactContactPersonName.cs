...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrganizationAsContact_contactPersonName")]
    public partial class OrganizationAsContactContactPersonName : IEquatable<OrganizationAsContactContactPersonName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationAsContactContactPersonName" /> class.
        /// </summary>
        ...
        public OrganizationAsContactContactPersonName(string givenName = default(string), string middleName = default(string), string familyName = default(string))
        {
        ...
        {
            return this.Equals(input as OrganizationAsContactContactPersonName);
        }

        /// <summary>
        /// Returns true if OrganizationAsContactContactPersonName instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganizationAsContactContactPersonName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationAsContactContactPersonName input)
        {
            if (input == null)
            {
                return false;
