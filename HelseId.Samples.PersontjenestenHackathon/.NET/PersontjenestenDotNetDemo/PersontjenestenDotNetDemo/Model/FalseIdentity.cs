...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FalseIdentity")]
    public partial class FalseIdentity : IEquatable<FalseIdentity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FalseIdentity" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as FalseIdentity);
        }

        /// <summary>
        /// Returns true if FalseIdentity instances are equal
        /// </summary>
        /// <param name="input">Instance of FalseIdentity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FalseIdentity input)
        {
            if (input == null)
            {
                return false;
