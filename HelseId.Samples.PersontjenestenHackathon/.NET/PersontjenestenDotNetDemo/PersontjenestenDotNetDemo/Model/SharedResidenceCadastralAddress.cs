...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SharedResidence_cadastralAddress")]
    public partial class SharedResidenceCadastralAddress : IEquatable<SharedResidenceCadastralAddress>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SharedResidenceCadastralAddress" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SharedResidenceCadastralAddress);
        }

        /// <summary>
        /// Returns true if SharedResidenceCadastralAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of SharedResidenceCadastralAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SharedResidenceCadastralAddress input)
        {
            if (input == null)
            {
                return false;
