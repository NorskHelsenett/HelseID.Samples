...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityVerification")]
    public partial class IdentityVerification : IEquatable<IdentityVerification>, IValidatableObject
    {

        /// <summary>
        /// Category of verification for the underlying identity  &lt;br&gt;FREG: Identitetsgrunnlagstatus
        /// </summary>
        /// <value>Category of verification for the underlying identity  &lt;br&gt;FREG: Identitetsgrunnlagstatus</value>
        [DataMember(Name = "identityVerificationStatus", EmitDefaultValue = false)]
        ...
        /// <param name="identityVerificationStatus">Category of verification for the underlying identity  &lt;br&gt;FREG: Identitetsgrunnlagstatus.</param>
        public IdentityVerification(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), IdentityVerificationStatus? identityVerificationStatus = default(IdentityVerificationStatus?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IdentityVerificationStatus: ").Append(IdentityVerificationStatus).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as IdentityVerification);
        }

        /// <summary>
        /// Returns true if IdentityVerification instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityVerification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityVerification input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.IdentityVerificationStatus == input.IdentityVerificationStatus ||
                    this.IdentityVerificationStatus.Equals(input.IdentityVerificationStatus)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.IdentityVerificationStatus.GetHashCode();
                return hashCode;
            }
        }
