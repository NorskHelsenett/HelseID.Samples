...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentifyingInformation")]
    public partial class IdentifyingInformation : IEquatable<IdentifyingInformation>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentifyingInformation" /> class.
        /// </summary>
        ...
        public IdentifyingInformation(IdentifyingInformationPersonName personName = default(IdentifyingInformationPersonName), DateTime? birthDate = default(DateTime?), List<string> citizenship = default(List<string>), Gender? gender = default(Gender?))
        {
        ...
        {
            return this.Equals(input as IdentifyingInformation);
        }

        /// <summary>
        /// Returns true if IdentifyingInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentifyingInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentifyingInformation input)
        {
            if (input == null)
            {
                return false;
