...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentificationDocument_documentVerification")]
    public partial class IdentificationDocumentDocumentVerification : IEquatable<IdentificationDocumentDocumentVerification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentificationDocumentDocumentVerification" /> class.
        /// </summary>
        ...
        public IdentificationDocumentDocumentVerification(string verificationStatus = default(string), DateTime? verifiedAt = default(DateTime?))
        {
        ...
        {
            return this.Equals(input as IdentificationDocumentDocumentVerification);
        }

        /// <summary>
        /// Returns true if IdentificationDocumentDocumentVerification instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentificationDocumentDocumentVerification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentificationDocumentDocumentVerification input)
        {
            if (input == null)
            {
                return false;
