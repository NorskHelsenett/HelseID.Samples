...
namespace Org.OpenAPITools.Model
{
    ...
    /// &lt;br&gt;FREG: Vegadresse
    /// </summary>
    [DataContract(Name = "PresentAddress_streetAddress")]
    public partial class PresentAddressStreetAddress : IEquatable<PresentAddressStreetAddress>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PresentAddressStreetAddress" /> class.
        /// </summary>
        ...
        public PresentAddressStreetAddress(string municipalityNumber = default(string), string separatelyOccupiedUnitNumber = default(string), SeparatelyOccupiedUnitType? separatelyOccupiedUnitType = default(SeparatelyOccupiedUnitType?), string addressName = default(string), StreetAddressAddressNumber addressNumber = default(StreetAddressAddressNumber), string addressCode = default(string), string addressAdditionalName = default(string), CadastralAddressCity city = default(CadastralAddressCity), string coAddressName = default(string))
        {
        ...
        {
            return this.Equals(input as PresentAddressStreetAddress);
        }

        /// <summary>
        /// Returns true if PresentAddressStreetAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of PresentAddressStreetAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PresentAddressStreetAddress input)
        {
            if (input == null)
            {
                return false;
