...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParentalResponsibility_responsibleWithoutIdentifier")]
    public partial class ParentalResponsibilityResponsibleWithoutIdentifier : IEquatable<ParentalResponsibilityResponsibleWithoutIdentifier>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ParentalResponsibilityResponsibleWithoutIdentifier" /> class.
        /// </summary>
        ...
        public ParentalResponsibilityResponsibleWithoutIdentifier(GuardianOrProxyName name = default(GuardianOrProxyName), DateTime? birthDate = default(DateTime?), string citizenship = default(string), Gender? gender = default(Gender?))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as ParentalResponsibilityResponsibleWithoutIdentifier);
        }

        /// <summary>
        /// Returns true if ParentalResponsibilityResponsibleWithoutIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of ParentalResponsibilityResponsibleWithoutIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParentalResponsibilityResponsibleWithoutIdentifier input)
        {
            if (input == null)
            {
                return false;
