...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonStatus")]
    public partial class PersonStatus : IEquatable<PersonStatus>, IValidatableObject
    {
        ...
        public PersonStatus(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), PersonStatusType? status = default(PersonStatusType?))
        {
        ...
        {
            return this.Equals(input as PersonStatus);
        }

        /// <summary>
        /// Returns true if PersonStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonStatus input)
        {
            if (input == null)
            {
                return false;
