...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PersonName : IEquatable<PersonName>, IValidatableObject
    {
        ...
        /// <param name="shortName">&lt;br&gt;FREG: ForkortetNavn.</param>
        /// <param name="originalName">originalName.</param>
        public PersonName(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), string givenName = default(string), string middleName = default(string), string familyName = default(string), string shortName = default(string), PersonNameOriginalName originalName = default(PersonNameOriginalName))
        {
        ...
        /// </summary>
        /// <value>&lt;br&gt;FREG: ForkortetNavn</value>
        ...
        public PersonNameOriginalName OriginalName { get; set; }
