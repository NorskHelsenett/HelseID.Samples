...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResiduaryEstateContactInformation_organization")]
    public partial class ResiduaryEstateContactInformationOrganization : IEquatable<ResiduaryEstateContactInformationOrganization>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResiduaryEstateContactInformationOrganization" /> class.
        /// </summary>
        ...
        public ResiduaryEstateContactInformationOrganization(string organizationName = default(string), string organizationNumber = default(string), OrganizationAsContactContactPersonName contactPersonName = default(OrganizationAsContactContactPersonName))
        {
        ...
        {
            return this.Equals(input as ResiduaryEstateContactInformationOrganization);
        }

        /// <summary>
        /// Returns true if ResiduaryEstateContactInformationOrganization instances are equal
        /// </summary>
        /// <param name="input">Instance of ResiduaryEstateContactInformationOrganization to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResiduaryEstateContactInformationOrganization input)
        {
            if (input == null)
            {
                return false;
