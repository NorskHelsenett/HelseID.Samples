...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmigrationFromNorway")]
    public partial class EmigrationFromNorway : IEquatable<EmigrationFromNorway>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmigrationFromNorway" /> class.
        /// </summary>
        ...
        /// <param name="emigratedToCountry">&lt;br&gt;FREG: Tilflyttingsland.</param>
        /// <param name="emigratedToCity">&lt;br&gt;FREG: TilflyttingsstedIUtlandet.</param>
        /// <param name="emigratedMoveDate">Reported as move date by person  &lt;br&gt;FREG: Utflyttingsdato.</param>
        public EmigrationFromNorway(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), string emigratedToCountry = default(string), string emigratedToCity = default(string), DateTime? emigratedMoveDate = default(DateTime?))
        {
        ...
        /// </summary>
        /// <value>&lt;br&gt;FREG: Tilflyttingsland</value>
        [DataMember(Name = "emigratedToCountry", EmitDefaultValue = true)]
        public string EmigratedToCountry { get; set; }

        /// <summary>
        /// &lt;br&gt;FREG: TilflyttingsstedIUtlandet
        /// </summary>
        /// <value>&lt;br&gt;FREG: TilflyttingsstedIUtlandet</value>
        [DataMember(Name = "emigratedToCity", EmitDefaultValue = true)]
        public string EmigratedToCity { get; set; }

        /// <summary>
        /// Reported as move date by person  &lt;br&gt;FREG: Utflyttingsdato
        /// </summary>
        /// <value>Reported as move date by person  &lt;br&gt;FREG: Utflyttingsdato</value>
        [DataMember(Name = "emigratedMoveDate", EmitDefaultValue = true)]
        public DateTime? EmigratedMoveDate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EmigratedToCountry: ").Append(EmigratedToCountry).Append("\n");
            sb.Append("  EmigratedToCity: ").Append(EmigratedToCity).Append("\n");
            sb.Append("  EmigratedMoveDate: ").Append(EmigratedMoveDate).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as EmigrationFromNorway);
        }

        /// <summary>
        /// Returns true if EmigrationFromNorway instances are equal
        /// </summary>
        /// <param name="input">Instance of EmigrationFromNorway to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmigrationFromNorway input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EmigratedToCountry == input.EmigratedToCountry ||
                    (this.EmigratedToCountry != null &&
                    this.EmigratedToCountry.Equals(input.EmigratedToCountry))
                ) && 
                (
                    this.EmigratedToCity == input.EmigratedToCity ||
                    (this.EmigratedToCity != null &&
                    this.EmigratedToCity.Equals(input.EmigratedToCity))
                ) && 
                (
                    this.EmigratedMoveDate == input.EmigratedMoveDate ||
                    (this.EmigratedMoveDate != null &&
                    this.EmigratedMoveDate.Equals(input.EmigratedMoveDate))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EmigratedToCountry != null)
                {
                    hashCode = (hashCode * 59) + this.EmigratedToCountry.GetHashCode();
                }
                if (this.EmigratedToCity != null)
                {
                    hashCode = (hashCode * 59) + this.EmigratedToCity.GetHashCode();
                }
                if (this.EmigratedMoveDate != null)
                {
                    hashCode = (hashCode * 59) + this.EmigratedMoveDate.GetHashCode();
                }
                return hashCode;
            }
        }
