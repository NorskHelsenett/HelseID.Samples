...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResidentialAddress_unknownResidence")]
    public partial class ResidentialAddressUnknownResidence : IEquatable<ResidentialAddressUnknownResidence>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResidentialAddressUnknownResidence" /> class.
        /// </summary>
        /// <param name="municipalityNumber">Persons adress is unknown, but the Municipality is known.  &lt;br&gt;FREG: Bostedskommune.</param>
        public ResidentialAddressUnknownResidence(string municipalityNumber = default(string))
        {
        ...
        /// </summary>
        /// <value>Persons adress is unknown, but the Municipality is known.  &lt;br&gt;FREG: Bostedskommune</value>
        ...
        {
            return this.Equals(input as ResidentialAddressUnknownResidence);
        }

        /// <summary>
        /// Returns true if ResidentialAddressUnknownResidence instances are equal
        /// </summary>
        /// <param name="input">Instance of ResidentialAddressUnknownResidence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResidentialAddressUnknownResidence input)
        {
            if (input == null)
            {
                return false;
