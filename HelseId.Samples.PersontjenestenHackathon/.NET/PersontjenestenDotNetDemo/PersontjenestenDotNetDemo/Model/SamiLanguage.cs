...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SamiLanguage")]
    public partial class SamiLanguage : IEquatable<SamiLanguage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SamiLanguage" /> class.
        /// </summary>
        ...
        /// <param name="language">&lt;br&gt;FREG: Spraak.</param>
        public SamiLanguage(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), List<SamiLanguageType> language = default(List<SamiLanguageType>))
        {
        ...
        /// &lt;br&gt;FREG: Spraak
        /// </summary>
        /// <value>&lt;br&gt;FREG: Spraak</value>
        [DataMember(Name = "language", EmitDefaultValue = true)]
        public List<SamiLanguageType> Language { get; set; }
        ...
        {
            return this.Equals(input as SamiLanguage);
        }

        /// <summary>
        /// Returns true if SamiLanguage instances are equal
        /// </summary>
        /// <param name="input">Instance of SamiLanguage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SamiLanguage input)
        {
            if (input == null)
            {
                return false;
