...
namespace Org.OpenAPITools.Model
{
    ...
    /// &lt;br&gt;FREG: Navn
    /// </summary>
    [DataContract(Name = "GuardianOrProxy_name")]
    public partial class GuardianOrProxyName : IEquatable<GuardianOrProxyName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GuardianOrProxyName" /> class.
        /// </summary>
        ...
        public GuardianOrProxyName(string givenName = default(string), string middleName = default(string), string familyName = default(string))
        {
        ...
        {
            return this.Equals(input as GuardianOrProxyName);
        }

        /// <summary>
        /// Returns true if GuardianOrProxyName instances are equal
        /// </summary>
        /// <param name="input">Instance of GuardianOrProxyName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GuardianOrProxyName input)
        {
            if (input == null)
            {
                return false;
