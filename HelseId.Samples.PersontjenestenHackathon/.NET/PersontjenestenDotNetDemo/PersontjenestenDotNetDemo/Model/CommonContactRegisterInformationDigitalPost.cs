...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CommonContactRegisterInformation_digitalPost")]
    public partial class CommonContactRegisterInformationDigitalPost : IEquatable<CommonContactRegisterInformationDigitalPost>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonContactRegisterInformationDigitalPost" /> class.
        /// </summary>
        /// <param name="digitalPostAddress">&lt;br&gt;KRR: postkasseadresse              A unique address for a persons post address with a post vendor.</param>
        /// <param name="digitalPostVendorAddress">&lt;br&gt;KRR: postkasseleverandoeradresse              org number for a post vendor.</param>
        public CommonContactRegisterInformationDigitalPost(string digitalPostAddress = default(string), string digitalPostVendorAddress = default(string))
        {
        ...
        /// </summary>
        /// <value>&lt;br&gt;KRR: postkasseadresse              A unique address for a persons post address with a post vendor</value>
        [DataMember(Name = "digitalPostAddress", EmitDefaultValue = true)]
        public string DigitalPostAddress { get; set; }

        /// <summary>
        /// &lt;br&gt;KRR: postkasseleverandoeradresse              org number for a post vendor
        /// </summary>
        /// <value>&lt;br&gt;KRR: postkasseleverandoeradresse              org number for a post vendor</value>
        [DataMember(Name = "digitalPostVendorAddress", EmitDefaultValue = true)]
        public string DigitalPostVendorAddress { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DigitalPostAddress: ").Append(DigitalPostAddress).Append("\n");
            sb.Append("  DigitalPostVendorAddress: ").Append(DigitalPostVendorAddress).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as CommonContactRegisterInformationDigitalPost);
        }

        /// <summary>
        /// Returns true if CommonContactRegisterInformationDigitalPost instances are equal
        /// </summary>
        /// <param name="input">Instance of CommonContactRegisterInformationDigitalPost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonContactRegisterInformationDigitalPost input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.DigitalPostAddress == input.DigitalPostAddress ||
                    (this.DigitalPostAddress != null &&
                    this.DigitalPostAddress.Equals(input.DigitalPostAddress))
                ) && 
                (
                    this.DigitalPostVendorAddress == input.DigitalPostVendorAddress ||
                    (this.DigitalPostVendorAddress != null &&
                    this.DigitalPostVendorAddress.Equals(input.DigitalPostVendorAddress))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.DigitalPostAddress != null)
                {
                    hashCode = (hashCode * 59) + this.DigitalPostAddress.GetHashCode();
                }
                if (this.DigitalPostVendorAddress != null)
                {
                    hashCode = (hashCode * 59) + this.DigitalPostVendorAddress.GetHashCode();
                }
                return hashCode;
            }
        }
