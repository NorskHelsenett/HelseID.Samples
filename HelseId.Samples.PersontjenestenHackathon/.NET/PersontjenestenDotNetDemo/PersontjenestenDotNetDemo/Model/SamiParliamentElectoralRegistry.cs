...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SamiParliamentElectoralRegistry")]
    public partial class SamiParliamentElectoralRegistry : IEquatable<SamiParliamentElectoralRegistry>, IValidatableObject
    {
        ...
        public SamiParliamentElectoralRegistryStatus? Status { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="SamiParliamentElectoralRegistry" /> class.
        /// </summary>
        ...
        /// <param name="resolutionDate">&lt;br&gt;FREG: Vedtaksdato.</param>
        public SamiParliamentElectoralRegistry(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), SamiParliamentElectoralRegistryStatus? status = default(SamiParliamentElectoralRegistryStatus?), DateTime resolutionDate = default(DateTime))
        {
        ...
        /// &lt;br&gt;FREG: Vedtaksdato
        /// </summary>
        /// <value>&lt;br&gt;FREG: Vedtaksdato</value>
        ...
        {
            return this.Equals(input as SamiParliamentElectoralRegistry);
        }

        /// <summary>
        /// Returns true if SamiParliamentElectoralRegistry instances are equal
        /// </summary>
        /// <param name="input">Instance of SamiParliamentElectoralRegistry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SamiParliamentElectoralRegistry input)
        {
            if (input == null)
            {
                return false;
