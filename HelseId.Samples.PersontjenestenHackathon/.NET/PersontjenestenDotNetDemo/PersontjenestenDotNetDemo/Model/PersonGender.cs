...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonGender")]
    public partial class PersonGender : IEquatable<PersonGender>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonGender" /> class.
        /// </summary>
        ...
        public PersonGender(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), Gender? gender = default(Gender?))
        {
        ...
        {
            return this.Equals(input as PersonGender);
        }

        /// <summary>
        /// Returns true if PersonGender instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonGender to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonGender input)
        {
            if (input == null)
            {
                return false;
