...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GuardianOrProxy")]
    public partial class GuardianOrProxy : IEquatable<GuardianOrProxy>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GuardianOrProxy" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GuardianOrProxy);
        }

        /// <summary>
        /// Returns true if GuardianOrProxy instances are equal
        /// </summary>
        /// <param name="input">Instance of GuardianOrProxy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GuardianOrProxy input)
        {
            if (input == null)
            {
                return false;
