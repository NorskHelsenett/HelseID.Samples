...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ContactAddress")]
    public partial class ContactAddress : IEquatable<ContactAddress>, IValidatableObject
    {
        ...
        /// <param name="postBoxAddress">postBoxAddress.</param>
        /// <param name="streetAddress">streetAddress.</param>
        /// <param name="freeFormPostalAddress">freeFormPostalAddress.</param>
        ...
        public ContactAddress(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), AddressConfidentiality? addressConfidentiality = default(AddressConfidentiality?), ContactAddressPostBoxAddress postBoxAddress = default(ContactAddressPostBoxAddress), ContactAddressStreetAddress streetAddress = default(ContactAddressStreetAddress), ContactAddressFreeFormPostalAddress freeFormPostalAddress = default(ContactAddressFreeFormPostalAddress), string cadastralIdentifier = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets PostBoxAddress
        /// </summary>
        [DataMember(Name = "postBoxAddress", EmitDefaultValue = true)]
        public ContactAddressPostBoxAddress PostBoxAddress { get; set; }

        /// <summary>
        /// Gets or Sets StreetAddress
        /// </summary>
        [DataMember(Name = "streetAddress", EmitDefaultValue = true)]
        public ContactAddressStreetAddress StreetAddress { get; set; }

        /// <summary>
        /// Gets or Sets FreeFormPostalAddress
        /// </summary>
        [DataMember(Name = "freeFormPostalAddress", EmitDefaultValue = true)]
        public ContactAddressFreeFormPostalAddress FreeFormPostalAddress { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PostBoxAddress: ").Append(PostBoxAddress).Append("\n");
            sb.Append("  StreetAddress: ").Append(StreetAddress).Append("\n");
            sb.Append("  FreeFormPostalAddress: ").Append(FreeFormPostalAddress).Append("\n");
        ...
        public bool Equals(ContactAddress input)
        {
            ...
            return 
                ...
                (
                    this.PostBoxAddress == input.PostBoxAddress ||
                    (this.PostBoxAddress != null &&
                    this.PostBoxAddress.Equals(input.PostBoxAddress))
                ) && 
                (
                ...
                (
                    this.FreeFormPostalAddress == input.FreeFormPostalAddress ||
                    (this.FreeFormPostalAddress != null &&
                    this.FreeFormPostalAddress.Equals(input.FreeFormPostalAddress))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.PostBoxAddress.GetHashCode();
                }
                if (this.StreetAddress != null)
                {
                    hashCode = (hashCode * 59) + this.StreetAddress.GetHashCode();
                }
                if (this.FreeFormPostalAddress != null)
                {
                    hashCode = (hashCode * 59) + this.FreeFormPostalAddress.GetHashCode();
                }
