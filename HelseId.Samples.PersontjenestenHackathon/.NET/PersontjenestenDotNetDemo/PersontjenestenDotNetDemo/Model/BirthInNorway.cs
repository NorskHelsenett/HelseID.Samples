...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BirthInNorway")]
    public partial class BirthInNorway : IEquatable<BirthInNorway>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BirthInNorway" /> class.
        /// </summary>
        ...
        /// <param name="organizationName">The organization/institution where the person was born, for example \&quot;Molde sjukehus\&quot;.  &lt;br&gt;FREG: Foedselsinstitusjonsnavn.</param>
        /// <param name="multipleBirthNumber">The number of this person if there were multiple births. This number is a combination of multiple data points:  First number &#x3D; the total number of children in multiple births  Second number &#x3D; this persons number in the sequence                Example: \&quot;21\&quot; means that this child was the firstborn twin (this person was the first of two births)  &lt;br&gt;FREG: Rekkefoelgenummer.</param>
        public BirthInNorway(DateTime? registeredAt = default(DateTime?), bool? isValid = default(bool?), string source = default(string), string reason = default(string), DateTime? validFrom = default(DateTime?), DateTime? validTo = default(DateTime?), string organizationName = default(string), long? multipleBirthNumber = default(long?))
        {
        ...
        /// </summary>
        /// <value>The organization/institution where the person was born, for example \&quot;Molde sjukehus\&quot;.  &lt;br&gt;FREG: Foedselsinstitusjonsnavn</value>
        ...
        /// </summary>
        /// <value>The number of this person if there were multiple births. This number is a combination of multiple data points:  First number &#x3D; the total number of children in multiple births  Second number &#x3D; this persons number in the sequence                Example: \&quot;21\&quot; means that this child was the firstborn twin (this person was the first of two births)  &lt;br&gt;FREG: Rekkefoelgenummer</value>
        [DataMember(Name = "multipleBirthNumber", EmitDefaultValue = true)]
        public long? MultipleBirthNumber { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MultipleBirthNumber: ").Append(MultipleBirthNumber).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as BirthInNorway);
        }

        /// <summary>
        /// Returns true if BirthInNorway instances are equal
        /// </summary>
        /// <param name="input">Instance of BirthInNorway to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BirthInNorway input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.MultipleBirthNumber == input.MultipleBirthNumber ||
                    (this.MultipleBirthNumber != null &&
                    this.MultipleBirthNumber.Equals(input.MultipleBirthNumber))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MultipleBirthNumber != null)
                {
                    hashCode = (hashCode * 59) + this.MultipleBirthNumber.GetHashCode();
                }
                return hashCode;
            }
        }
