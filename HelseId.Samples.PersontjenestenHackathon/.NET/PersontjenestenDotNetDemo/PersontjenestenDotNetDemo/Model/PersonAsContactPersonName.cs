...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonAsContact_personName")]
    public partial class PersonAsContactPersonName : IEquatable<PersonAsContactPersonName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonAsContactPersonName" /> class.
        /// </summary>
        ...
        public PersonAsContactPersonName(string givenName = default(string), string middleName = default(string), string familyName = default(string))
        {
        ...
        {
            return this.Equals(input as PersonAsContactPersonName);
        }

        /// <summary>
        /// Returns true if PersonAsContactPersonName instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonAsContactPersonName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonAsContactPersonName input)
        {
            if (input == null)
            {
                return false;
