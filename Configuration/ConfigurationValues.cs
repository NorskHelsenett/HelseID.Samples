...
public static class ConfigurationValues
{
    ...
    private static readonly string? IssuerUriFromEnvironment = Environment.GetEnvironmentVariable("PrivateHelseIdUrl");
    public static string IssuerUri { get;  } = IssuerUriFromEnvironment ?? "https://helseid-sts.test.nhn.no";
