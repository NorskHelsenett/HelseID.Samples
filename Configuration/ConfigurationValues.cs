...
public static class ConfigurationValues 
{
    ...
    public const string ApiAccessWithRequestObjectSampleScope = $"openid profile offline_access {AuthorizationCodeScopeForSampleApi}";
    public const string ApiAccessResourceIndicatorClientScope = $"openid profile offline_access {SampleApiForResourceIndicators1Scope} {SampleApiForResourceIndicators2Scope} helseid://scopes/identity/pid helseid://scopes/identity/security_level";
